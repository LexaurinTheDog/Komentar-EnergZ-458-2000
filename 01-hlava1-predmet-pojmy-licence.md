# Část první, Hlava I — Předmět, pojmy a licence (§§ 1–10)

> **Téma kapitoly:** Hlava I Části první energetického zákona tvoří pojmový a institucionální základ celého kodexu. § 1 vymezuje předmět úpravy a zakotvuje transpozici unijního práva; § 2 definuje téměř stovku technických pojmů pro elektroenergetiku, plynárenství a teplárenství. § 3 stanovuje, co je předmětem podnikání v energetických odvětvích, a zavádí povinnost licence jako podmínku vstupu na trh; §§ 3a–3e pak přinášejí zvláštní režim souhlasu ministerstva s nabytím vlivu nad energeticky strategickým celkem — nástroj ochrany energetické bezpečnosti. §§ 4–8 upravují licenční řízení v plném rozsahu: druhy licencí a doby jejich platnosti (§ 4), podmínky udělení včetně bezúhonnosti, odborné způsobilosti a finančních a technických předpokladů (§ 5), překážky udělení licence pro obchodníky (§ 5a), institut odpovědného zástupce (§ 6), žádost o licenci a řízení (§ 7 a § 7a), obsah a zvláštní pravidla rozhodnutí o udělení (§ 8). § 9 upravuje změny rozhodnutí o udělení licence za trvání licence. § 10 pak komplexně řeší zánik a zrušení licence včetně zvláštních pravidel pro dědice a přeměny právnických osob. Tato hlava je proto nezbytnou výchozí četbou pro každého účastníka trhu v energetice i pro regulátora.

---

### § 1 — Předmět úpravy a vztah k právu EU

> **§ 1**
>
> *Tento zákon zapracovává příslušné předpisy Evropské unie a upravuje v návaznosti na přímo použitelné předpisy Evropské unie podmínky podnikání a výkon státní správy v energetických odvětvích, kterými jsou elektroenergetika, plynárenství a teplárenství, jakož i práva a povinnosti fyzických a právnických osob s tím spojené.*

**Výklad:**

#### Transpozice unijního práva a odkaz na přímo použitelné předpisy

§ 1 plní dvojí funkci. Za prvé deklaruje, že zákon **zapracovává příslušné předpisy Evropské unie** — jde o transpozici směrnic, zejm. recastové směrnice Evropského parlamentu a Rady 2019/944 o společných pravidlech pro vnitřní trh s elektřinou a směrnice 2009/73/ES o společných pravidlech pro vnitřní trh se zemním plynem (resp. jejích novel). Za druhé zákon výslovně odkazuje na **přímo použitelné předpisy EU** — nařízení, která nevyžadují transpozici a jsou přímo závazná (typicky nařízení Evropského parlamentu a Rady (EU) 2019/943 o vnitřním trhu s elektřinou, nařízení (EU) 2017/1938 o bezpečnosti dodávek zemního plynu, či nařízení (EU) č. 1227/2011 o integritě a transparentnosti velkoobchodního trhu s energií — REMIT). Energetický zákon je tedy jen jednou vrstvou regulace: vedle jeho ustanovení se přímo aplikují četná unijní nařízení a prováděcí akty Komise.

#### Rozsah věcné působnosti

Zákon se vztahuje na tři energetická odvětví: **elektroenergetiku**, **plynárenství** a **teplárenství**. Toto trojdělení se prolíná celou strukturou zákona — většina institutů (licence, sítě, přístup třetích stran, ochrana zákazníka) je upravena paralelně pro každé z odvětví. Zákon neurčuje věcný rozsah „energetiky" volně — výlučně na základě pojmového aparátu § 2 a výčtu licencovaných činností § 3.

#### Adresáti a subjekty zákona
...
>
> *- e) energeticky strategickým celkem prvek nebo systém prvků kritické infrastruktury v odvětví energetika v oblasti elektřiny, zemního plynu nebo centrálního zásobování teplem,*
>
...
#### Klíčové pojmy odst. 1

**Vymezené území** (písm. a) je zásadní pro distribuci: distributorovi elektřiny, plynu nebo tepla přísluší výkon licence výlučně na geograficky určeném území. Z tohoto pojmu vyplývají jak práva (výhradní přístup k síti), tak povinnosti (povinnost připojení a dodávky v rámci vymezeného území) — podrobněji viz [02-hlava1-prava-povinnosti-ochrana-zakaznika.md](02-hlava1-prava-povinnosti-ochrana-zakaznika.md).

**Kontrola** (písm. b) je vymezena funkcionálně — rozhodující vliv na základě vlastnického nebo hlasovacího práva, nikoliv pouhá majetková účast. Tento pojem je klíčový pro pravidla unbundlingu (oddělení přenosu/přepravy od výroby a obchodu — §§ 24a, 58a a násl.) a pro nová pravidla souhlasu s nabytím vlivu nad energeticky strategickým celkem (§§ 3a–3e).

**Energeticky strategický celek a navazující pojmy** (písm. e–i) byly do zákona vloženy jako reakce na bezpečnostní výzvy spojené s rizikem ovládnutí kritické energetické infrastruktury zahraničními subjekty. Pojem „účinné míry kontroly" (písm. f a g) je záměrně širší než pojem kontroly z písm. b) — zahrnuje i nepřímé dispoziční možnosti, přístupy k systémům a informacím. Aktivací těchto pojmů nastupuje povinný schvalovací mechanismus ministerstva (§§ 3a–3e).

**Dynamické určení ceny** (písm. j) a **smlouva s pevnou cenou** (písm. l) jsou nové pojmy zavedené v rámci implementace unijního balíčku „čistá energie" — odrážejí zvýšenou rozmanitost smluvních produktů na retailovém trhu. **Index zajištění obchodníka** (písm. k) slouží jako indikátor finanční stability obchodníka vůči ERÚ a je jedním z podkladů pro monitoring a případné zrušení licence.

#### Odvětvové pojmy odst. 2

Definice sítí a soustav (přenosová soustava, přepravní soustava, distribuční soustava v elektro i plynu, rozvodné tepelné zařízení) jsou nezbytné pro vymezení povinností jejich provozovatelů — zejm. povinností přístupu třetích stran. Zákon výslovně prohlašuje přenosovou soustavu, přepravní soustavu, zásobníky plynu, těžební plynovody a výrobny plynu za věci zřizované a provozované **ve veřejném zájmu** — to má přímé důsledky pro vyvlastňovací řízení a stavební zákon.

Nová definice **vodíkové přepravní soustavy** (písm. b bod 38) a **vodíku vysokého stupně čistoty** (bod 39) odráží aktuální směřování energetické politiky EU k vodíkové ekonomice — zákon tak vytvořil základní pojmový rámec pro budoucí vodíkovou přepravní infrastrukturu.
...
#### Veřejný zájem a vyvlastňovací oprávnění (odst. 2)

Odstavec 2 je klíčovým ustanovením z pohledu veřejného práva: výslovně prohlašuje řadu energetických činností za konané **ve veřejném zájmu**. Toto prohlášení má trojí důsledek: (i) energetická infrastruktura podléhá zvláštnímu režimu budování (veřejnoprávní povolení, urychlení výstavby), (ii) pro zřízení a provoz klíčové infrastruktury lze uplatnit **vyvlastnění nebo omezení vlastnického práva** podle zvláštních předpisů (zákon č. 184/2006 Sb. o vyvlastnění), (iii) zmíněné stavby jsou zřizovány a provozovány ve veřejném zájmu se všemi procesními dopady (přednostní posuzování apod.). Stavby pro energetickou bezpečnost podle zákona o urychlení výstavby strategicky významné infrastruktury jsou explicitně zmiňovány jako nová kategorie — zákon reflektuje legislativní vývoj po roce 2022.

#### Povinná a nepovinná licence (odst. 3–5)
...
§§ 3a–3e tvoří kompaktní skupinu ustanovení vloženou do Hlavy I Části první mezi obecnou licenční část a samotnou úpravu licencí. Jejich účelem je ochrana energeticky strategické infrastruktury před nežádoucím nabytím kontroly — zejm. ze strany zahraničních státních nebo jinak geopoliticky exponovaných subjektů. Jde o implementaci obecné logiky unijních nástrojů prověřování zahraničních investic (nařízení (EU) 2019/452), aplikovanou specificky na energetiku.

#### § 3a — Zákaz nabytí bez souhlasu a fikce souhlasu
...
### § 4 — Licence — druhy a doby platnosti
...
#### Tři kategorie podle doby platnosti

§ 4 třídí licence do tří skupin podle doby platnosti:

| Kategorie | Doba | Licence |
|---|---|---|
| Výrobní a storage | max. 25 let | výroba elektřiny, plynu, tepla; ukládání elektřiny |
| Síťové a regulované monopoly | neurčitá | přenos, přeprava, distribuce, uskladňování plynu, rozvod tepla, operátor trhu, datové centrum |
| Obchodní | 5 let | obchod s elektřinou, obchod s plynem |

Doby platnosti odrážejí charakter činnosti: provozovatelé sítí a monopolní infrastruktury potřebují stabilitu na neurčito (jinak by investice do sítí nebyly financovatelné), výrobci mají zpravidla licence vázané na životnost zařízení (do 25 let), obchodníci podléhají pravidelnému přezkumu každých 5 let (resp. prodloužení dle § 9 odst. 6).

#### Výlučné licence (odst. 2)

Přenos elektřiny, přeprava plynu, činnosti operátora trhu a datového centra jsou **výlučné pro celé území ČR** — může je vykonávat vždy jen jeden subjekt. Jde o přirozené monopoly, u nichž by duplicita infrastruktury ekonomicky nedávala smysl. Tato výlučnost odůvodňuje i přísnou regulaci ERÚ — viz [03-hlava1-eru-regulace-ceny.md](03-hlava1-eru-regulace-ceny.md).

#### Kratší doba licence při omezeném věcném právu (odst. 3)

Pokud žadatel doloží pouze nájemní nebo jiné užívací právo k energetickému zařízení na dobu kratší, než je zákonná doba licence, ERÚ udělí licenci maximálně na dobu trvání takového práva. Tím zákon brání situaci, kdy by licenci měla osoba, která po uplynutí práva k zařízení fakticky nemůže činnost vykonávat.
...
#### Struktura podmínek — fyzické a právnické osoby

Zákon rozlišuje podmínky pro fyzické osoby (odst. 1: svéprávnost, bezúhonnost, odbornost nebo odpovědný zástupce) a pro právnické osoby (odst. 2: podmínky bezúhonnosti a svéprávnosti dopadají na členy statutárního orgánu; odpovědný zástupce je povinný vždy, s výjimkou licence operátora trhu a datového centra). Tato diferenciace je systémová: u právnické osoby samotné nelze hovořit o svéprávnosti v civilněprávním smyslu, zákon proto správně navazuje na fyzické osoby jednající za PO.

#### Bezúhonnost — trojí negativní vymezení (odst. 4)

Zákon bezúhonnost nevymezuje pozitivně, ale negativně — jako absenci tří typů pravomocného odsouzení. Třetí kategorie (nedbalostní trestné činy spojené s předmětem podnikání v energetice) je specificky energetická — postihuje např. spáchání nedbalostního trestného činu v oblasti bezpečnosti provozu (§ 272 a násl. trestního zákoníku č. 40/2009 Sb.). Bezúhonnost se ztrácí jen tehdy, pokud se na osobu nehledí jako na neodsouzenou — zahlazení odsouzení tedy obnovuje způsobilost žádat o licenci.

#### Odborná způsobilost — třistupňová škála (odst. 5)

Zákon rozlišuje tři stupně požadavků:
1. VŠ technického směru + 3 roky praxe (resp. ÚSO s maturitou + 6 let) — pro velké výrobní a síťové licence;
2. Vyučení v oboru + 3 roky (nebo rekvalifikace) — pro malé zdroje do 1 MW;
3. Žádná povinná odbornost — pro OZE výrobny do 100 kW a storage do 100 kW.

Tato liberalizace pro malé obnovitelné zdroje odráží záměr zákonodárce usnadnit rozvoj distribuované energetiky a snížit administrativní zátěž pro provozovatele střešních FV systémů a malých akumulátorů.

#### Finanční předpoklady — insolvence a daňové nedoplatky (odst. 6)

Zákon konstruuje finanční nezpůsobilost jako objektivní faktický stav: probíhající insolvence, post-insolvence (3 roky po zrušení konkursu) nebo existence evidovaných daňových, celních nebo pojistných nedoplatků. Jde o automatické negativní předpoklady bez nutnosti správního uvážení ERÚ — ERÚ si příslušné informace aktivně vyžaduje (§ 7 odst. 5 a 6). Nedoplatky, pro které bylo povoleno posečkání nebo splátky, se do výluky nezapočítávají.

#### Provoz pro ověření technologie (odst. 11)
...
#### Účel a systematika § 5a

§ 5a zakotvuje zvláštní **protektorát trhu s elektřinou a plynem** — jde o přísnou ochranu zákazníků před opakovaným selháním obchodníků. Zákon vychází ze zkušenosti, kdy nesolventní nebo neseriózní obchodník ukončí činnost (zrušení licence, insolvence), ale tatáž osoba nebo lidé, kteří ji ovládali, záhy obnoví podnikání pod novou entitou. § 5a tuto cestu na 5 let blokuje.

#### Trojí skupina překážek

Zákon rozlišuje tři autonomní skupiny překážek:
- **Odst. 1** — navazuje na zrušení licence z důvodu ohrožení zákazníků nebo závažného porušení předpisů (§ 10 odst. 2 písm. b) a c)) nebo insolvence (§ 10 odst. 3 písm. b)). Překážka postihuje nejen samotného obchodníka, ale i **bývalé členy statutárního orgánu** a nové entity ovládané těmito osobami.
- **Odst. 2** — navazuje na zahájení dodávky poslední instance (§ 12a odst. 2) — tj. situaci, kdy obchodník přestal dodávat zákazníkům a musela nastoupit dodávka z poslední instance. I tato událost zakládá 5letou překážku.
- **Odst. 3** — čistě insolvenční překážka: splnění rozvrhového usnesení, zastavení řízení pro nedostatečný majetek nebo zrušení konkursu pro totéž.

#### Promíjení překážky pro členy statutárního orgánu (odst. 4)
...
Odpovědný zástupce je zákonný zprostředkovatel odborné způsobilosti pro výkon licencované činnosti. U **fyzické osoby** se vyžaduje jen tehdy, nesplňuje-li sama podmínku odborné způsobilosti (odst. 3 věta druhá); u **právnické osoby** je povinný vždy — výjimkou jsou pouze licence operátora trhu a datového centra (§ 5 odst. 2). Odpovědný zástupce musí sám splňovat veškeré podmínky pro udělení licence jako fyzická osoba (odst. 2), tedy i bezúhonnost.

#### Neslučitelnost s kontrolní funkcí (odst. 4)

Zákon výslovně zakazuje kumulaci funkce odpovědného zástupce a člena dozorčí rady nebo jiného kontrolního orgánu. Tím zákon brání konfliktu zájmů: odpovědný zástupce odpovídá za provoz, kontrolní orgán ho má kontrolovat — tyto funkce nesmí splývat v jedné osobě.
...
>
> *- a) bezúhonnosti žadatele vyžádá podle zvláštního právního předpisu výpis z rejstříku trestů; žádost o vydání výpisu z rejstříku trestů a výpis z rejstříku trestů se předává v elektronické podobě, a to prostřednictvím veřejných datových sítí,*
>
...
#### Aktivní zjišťovací povinnost ERÚ (odst. 5–6)

Zákon výslovně ukládá ERÚ aktivně si vyžádat výpis z rejstříku trestů a ověřit finanční předpoklady z databází finanční správy, celní správy a správy sociálního zabezpečení. ERÚ tak nemusí spoléhat výhradně na žadatelem předložené doklady — a žadatel nemá právo tato zjišťování blokovat. Finanční orgány a OSSZ jsou povinny dodat vyžádané doklady do **7 dnů** (odst. 7).

#### Pětiletá lhůta pro opětovné udělení po zrušení (odst. 8)
...
§ 7a implementuje zásadu vzájemného uznávání oprávnění v rámci vnitřního trhu EU pro obchodníky s elektřinou a plynem. Osoba s platnou obchodní licencí (nebo rovnocenným oprávněním) z jiného členského státu EU nemusí absolvovat plnohodnotné licenční řízení — stačí žádost o **uznání** oprávnění u ERÚ. ERÚ rozhodne o uznání, pokud je doloženo, že zahraniční oprávnění opravňuje k obchodu s elektřinou nebo plynem.

#### Fikce držitele licence
...
#### Fikce licence — volný pohyb služeb

Odst. 1 věta druhá zakotvuje zvláštní mechanismus pro obchodníky s elektřinou a plynem: licence vzniká i marným uplynutím lhůty dle zákona o volném pohybu služeb (zákon č. 222/2009 Sb., §§ 28–30). Jde o transpozici směrnice 2006/123/ES o službách na vnitřním trhu — ERÚ, pokud ve lhůtě nerozhodne, je povinen licenci vydat.

#### Obsah rozhodnutí o udělení licence (odst. 2)

Rozhodnutí o udělení licence má zákonem taxativně vymezený obsah (písm. a–h). Klíčovými prvky jsou: identifikace držitele, předmět a rozsah podnikání, vymezené území (u distribuce a rozvodu), technické podmínky, termín zahájení činnosti, doba platnosti a seznam provozoven. Rozhodnutí zároveň schvaluje odpovědného zástupce (písm. f) — jde tedy o sdružené rozhodnutí v jednom správním aktu.

#### Princip „jedna licence na jedno zařízení" (odst. 3)

Na každé výrobní, síťové, skladovací nebo ukládací zařízení lze vydat jen jednu licenci. Tím zákon brání licenční pluralitě pro totéž zařízení a zajišťuje přehlednost registru licencí.

#### Udělení licence před zápisem do OR (odst. 5–7)

Pro zahraniční osoby a zakládané české právnické osoby platí možnost získat licenci ještě před zápisem do obchodního rejstříku. Podmínkou pro PO je prokázání, že byla **založena** (ne nutně zapsána). Pokud žadatel nezajistí zápis do 90 dnů od doručení rozhodnutí, **platnost rozhodnutí o udělení licence zaniká** — jde o zákonnou dobu platnosti „předběžné licence".

#### Energetický regulační věstník — publicita (odst. 8)
...
Zákon ukládá držiteli licence **neprodleně** oznamovat jakékoliv změny podmínek nebo údajů relevantních pro licenci. Tato povinnost je kontinuální — nezanikla udělením licence. U síťových provozovatelů zákon zavádí zjednodušený režim: nová zařízení v rámci vymezeného území se oznamují souhrnně každoročně do 30. dubna v rámci regulačních výkazů, přičemž ERÚ sám zahajuje řízení o změně licence z moci úřední.

#### Změna z moci úřední (odst. 3)

ERÚ může měnit rozhodnutí o udělení licence i bez návrhu — dozví-li se o skutečnostech, které změnu odůvodňují. Jde o projev veřejného zájmu na správnosti a aktuálnosti licencí.

#### Zmenšení rozsahu licence — přiměřená aplikace § 10 (odst. 4)

Pokud změna licence spočívá v omezení rozsahu (zmenšení vymezeného území, zúžení seznamu provozoven), zákon přikazuje přiměřené použití § 10 odst. 4–9 — tedy pravidel o zrušení licence. Tím zákon chrání zákazníky v dotčeném území: ERÚ může odložit účinky omezení licence až o 12 měsíců, pokud existuje naléhavá potřeba zachování výkonu licencované činnosti.
...
#### Systém zániku licence — pět způsobů (odst. 1)

Zákon rozlišuje pět způsobů zániku licence:
1. **Smrt fyzické osoby** — zánik ex lege (s výjimkou pokračování dědiců dle odst. 8–10);
2. **Zánik právnické osoby nebo přeměna** — zánik ex lege (s výjimkou odst. 11);
3. **Uplynutí doby** — zánik ex lege (relevantní pro výrobní a obchodní licence);
4. **Rozhodnutí ERÚ o zrušení** — správní akt;
5. **Rozhodnutí soudu o zrušení** — soudní akt (typicky při výkonu soudního dohledu).

#### Povinné a fakultativní zrušení (odst. 2 vs. odst. 3)

Zákon rozlišuje důvody povinného zrušení (odst. 2 — ERÚ **zruší**) a fakultativního zrušení (odst. 3 — ERÚ **může** zrušit). Povinné zrušení nastává při ohrožení osob, závažném porušení předpisů, skončení provozu obchodního závodu v insolvenčním řízení nebo na vlastní žádost. Fakultativní zrušení pokrývá situace jako: nezahájení činnosti, insolvence, finanční nezpůsobilost, likvidace, nezaplacení příspěvku do Energetického regulačního fondu, neplacení za síťové služby nebo pokračování ve výrobě po oznamovaném ukončení. Toto rozdělení má procesní důsledky: při povinném zrušení nemá ERÚ diskreci; při fakultativním zrušení musí zvážit proporcionalitu (zejm. odst. 4 — odložení účinků).

#### Odložení účinků zrušení — až 12 měsíců (odst. 4–5)

Jsou-li dány důvody povinného zrušení, ERÚ může přesto odložit účinek zrušení až o 12 měsíců, pokud existuje **naléhavá potřeba zachování výkonu licencované činnosti** (typicky u distribuce nebo rozvodu tepla — zákazníci by zůstali bez dodávek). Toto opatření chrání zákazníky a umožňuje organizovaný přechod. Odložení se neuplatní, prokáže-li držitel licence, že nemůže plnit povinnosti pro překážky mimo jeho kontrolu — pak může naopak požádat o zkrácení doby odložení.

#### Povinnosti při žádosti o zrušení (odst. 6)

Kdo sám žádá o zrušení své licence, musí zároveň předložit **návrh na řešení** vzniklé situace a prokázat, že informoval všechny smluvní partnery (zákazníky, provozovatele sítí) o zamýšleném ukončení. Tím zákon zajišťuje organizovaný výstup z trhu bez poškození zákazníků.

#### Pokračování po smrti držitele — licence osobně-smluvní (odst. 8–10)

Zákon zavádí pro případ smrti fyzické osoby zvláštní přechodný režim: dědicové, pozůstalý manžel (jsou-li spoluvlastníky energetického zařízení) nebo správce pozůstalosti mohou dočasně pokračovat ve výkonu licencované činnosti na základě stávající licence, a to **až do skončení řízení o dědictví**. Tím zákon chrání kontinuitu provozu (zejm. u menších výroben tepla nebo elektřiny). Po skončení dědického řízení musí pokračující osoba podat vlastní žádost o licenci do 1 měsíce — do vydání rozhodnutí pokračuje na základě licence zemřelého.
...
> **Pokračování:** [02-hlava1-prava-povinnosti-ochrana-zakaznika.md](02-hlava1-prava-povinnosti-ochrana-zakaznika.md) — Hlava I pokračuje právy a povinnostmi držitelů licencí, zákazníků a ochranou spotřebitele; [03-hlava1-eru-regulace-ceny.md](03-hlava1-eru-regulace-ceny.md) — Hlava I, oddíl regulace cen a pravomoci ERÚ.
