# Část první, Hlava II, Díl 1 — Elektroenergetika: účastníci trhu, soustavy (§§ 22–28)

> **Téma kapitoly:** Díl 1 Hlavy II upravuje **elektroenergetický segment** energetického zákona. Tato kapitola pokrývá katalog účastníků trhu s elektřinou (§ 22) a podrobná práva a povinnosti klíčových subjektů: výrobce elektřiny (§ 23), provozovatele zařízení pro ukládání elektřiny (§ 23a), provozovatele přenosové soustavy (§ 24) a jeho vlastnického oddělení (§ 24a), provozovatele distribuční soustavy (§ 25) a jeho funkčního oddělení (§ 25a), pravidel vlastnictví zařízení pro ukládání energie a dobíjecích stanic (§ 25b), technických dispečinků (§ 26, § 26a), datového centra (§§ 27–27f) a zákazníka (§ 28). Operátor trhu (OTE) je upraven v § 20a (Hlava I, Díl 3), jenž předchází tomuto dílu; v katalogu § 22 odst. 1 písm. d) je OTE formálně zařazen mezi účastníky trhu s elektřinou. Ústředním normativním tématem kapitoly je **unbundling** — povinné oddělení provozování sítí (přenosová a distribuční soustava) od výroby a obchodu s elektřinou — transponující požadavky směrnice 2019/944/EU o společných pravidlech vnitřního trhu s elektřinou a nařízení 2019/943/EU o vnitřním trhu s elektřinou. Na ochranu spotřebitele a ombudsmana odkazuje [04-hlava1-ochrana-spotrebitele-ombudsman.md](04-hlava1-ochrana-spotrebitele-ombudsman.md); na navazující ustanovení (obchodník s elektřinou § 30, agregátor § 31 aj.) odkazuje [06-hlava2-dil1-elektroenergetika-b.md](06-hlava2-dil1-elektroenergetika-b.md).
...
#### Katalog účastníků — vývoj a struktura

§ 22 odst. 1 podává **uzavřený katalog** deseti kategorií účastníků trhu s elektřinou. Katalog byl v průběhu let rozšiřován novelami energetického zákona; do stavu k 1. 1. 2026 přibyly oproti původnímu znění zejména **společenství** (transponující čl. 2 bod 11 směrnice 2019/944), **datové centrum** (nový institut správy měřených dat zavedený zákonem č. 131/2024 Sb.) a **provozovatelé zařízení pro ukládání elektřiny** (transponující čl. 36–38 směrnice 2019/944). Agregátoři jsou v zákoně samostatně definováni a mají vlastní katalog práv a povinností (viz [06-hlava2-dil1-elektroenergetika-b.md](06-hlava2-dil1-elektroenergetika-b.md)).

Pojmy jednotlivých kategorií jsou definovány v § 2 zákona (vymezení pojmů). Operátor trhu — ač uveden v písm. d) — je institucionálně upraven v § 20a (Hlava I, Díl 3 obecné části elektroenergetiky a plynárenství); v tomto dílu se jeho konkrétní povinnosti projevují nepřímo prostřednictvím informačních a registračních povinností ostatních účastníků vůči OTE.

#### Odpovědnost za odchylku a zúčtování (odst. 2)

Odst. 2 formuluje obecnou zásadu: každý účastník trhu nese **odpovědnost za odchylku**, tj. za rozdíl mezi sjednaným a skutečným dodaným nebo odebraným množstvím elektřiny v daném časovém intervalu. Tato odpovědnost je základem fungování vyrovnávacího trhu — operátor trhu vyhodnocuje odchylky, zúčtovává je a vypořádává finanční důsledky. Zákon výslovně připouští **přenos odpovědnosti za odchylku smluvně na jiný subjekt zúčtování**: typicky výrobce přenese odpovědnost na obchodníka, zákazník na dodavatele elektřiny. Přenos odpovědnosti musí být sjednán smlouvou o zúčtování odchylek s operátorem trhu.

#### Povinnost hradit poplatky bez smlouvy o distribuci (odst. 3)
...
>
> *- k) informovat účastníky trhu s elektřinou na svých internetových stránkách 1. o podílu zdrojů elektřiny použitých pro výrobu elektřiny v uplynulém roce, 2. o množství emisí CO2 a o množství radioaktivního odpadu vyprodukovaného při výrobě elektřiny v uplynulém roce,*
>
...
>
> *- t) plnit a vykazovat plnění kritérií udržitelnosti a úspor emisí skleníkových plynů podle zákona o podporovaných zdrojích energie v případě elektřiny vyrobené z pevných paliv z biomasy nebo biokapalin (za podmínek blíže uvedených v zákoně).*
>
...
#### Právo na připojení a dodávku (odst. 1 písm. a–c)

Právo výrobce na připojení k elektrizační soustavě (písm. a) je podmíněné — vzniká jen při splnění podmínek připojení a obchodních podmínek v Pravidlech provozování soustavy. Nejde tedy o absolutní veřejnoprávní nárok, nýbrž o **podmíněné subjektivní právo**, jehož rozsah vymezuje regulátor (ERÚ schvaluje Pravidla provozování přenosové soustavy a distribučních soustav). Právo dodávat elektřinu (písm. b) zahrnuje dodávky přenosovou nebo distribuční soustavou i **přímým vedením** — alternativa přímého vedení umožňuje výrobci dodávat konkrétnímu odběrateli bez využití regulované sítě; přímá vedení jsou regulována samostatně.

#### Právo poskytovat podpůrné služby a flexibilitu (odst. 1 písm. d)

Novelou transponující směrnici 2019/944 bylo výslovně zakotveno právo výrobce poskytovat flexibilitu nejen jako podpůrnou službu pro operátora soustavy, ale i **pro jiné účely** (např. obchodní), a to prostřednictvím agregátora. Podmínka průběhového měření u předávacího místa je technicky nezbytná pro přesné vyhodnocení flexibility.

#### Právo sdílet elektřinu (odst. 1 písm. g–h)

Písm. g a h zavádějí právo výrobce **sdílet vlastní elektřinu** — buď s využitím soustavy (do jiného předávacího místa téhož výrobce nebo zákazníků), nebo bez jejího využití (mezi předávacími místy za jednou pojistkovou skříní). Sdílení bez soustavy je fyzicky podmíněno tím, že odběrná místa jsou připojena přes jednu společnou hlavní domovní pojistkovou nebo kabelovou skříň. Detailní procesní pravidla sdílení jsou obsažena v §§ 27d–27f.

#### Právo uzavřít smlouvu o agregaci bez souhlasu dodavatele (odst. 1 písm. k)

Toto ustanovení je výsledkem transpozice čl. 17 odst. 4 směrnice 2019/944: výrobce může uzavřít smlouvu s agregátorem nezávisle na svém dodavateli, aniž by potřeboval jeho souhlas. Tím se odstraňuje potenciální konflikt zájmů vertikálně integrovaných skupin.

#### Povinnosti výrobce při vyvlastnění a věcných břemenech (odst. 2)

Odst. 2 upravuje zvláštní situaci: výrobce velké výrobny (100 MW a více) s povinností poskytovat podpůrné služby si musí zajistit nemovitost **smluvně za tržní cenu** (dle oceňovacího předpisu). Teprve při nedostupnosti vlastníka nebo neúspěchu dohody nastupuje vyvlastňovací řízení. Jde o průlom do obecného insolačního práva ve prospěch energetické bezpečnosti; analogické pravidlo platí pro provozovatele přenosové soustavy (§ 24 odst. 4).

#### Rozsáhlý katalog provozních povinností (odst. 3)

Odst. 3 zahrnuje 20 písmenných povinností (a–t). Z hlediska systematiky lze povinnosti rozdělit do skupin:

| Skupina | Povinnosti | Obsah |
|---|---|---|
| Technické připojení | písm. a–c | Vlastní náklady na připojení, měřicí zařízení |
| Podpůrné služby | písm. d | Výrobny ≥ 30 MW: povinná instalace zařízení podpůrných služeb |
| Dispečerské řízení | písm. e, h, n | Podřízenost pokynům dispečinku |
| Datové povinnosti | písm. f, g | Předávání dat OTE a provozovatelům soustav |
| Kvalita elektřiny | písm. i | Dodržování parametrů dle Pravidel |
| Úhrada nákladů připojení | písm. j | Paušální příspěvek, částečně nevratný |
| Informační povinnosti | písm. k | Zveřejnění palivového mixu a emisí na webu |
| Stav nouze | písm. l | Nabídka nevyužitých kapacit na pokyn |
| Registrace | písm. m | Do 30 dnů od licence u OTE |
| Dispečerské vybavení | písm. o | Výrobny ≥ 100 kW: zařízení dispečerského řízení |
| Havarijní plánování | písm. p | Do 6 měsíců od licence; povinnost pro výrobny ≥ 10 MW |
| Adaptace na parametry | písm. q | Přizpůsobení zařízení změně parametrů sítě |
| Bezpečná instalace OZE | písm. r | Výrobny do 100 kW bez povolení záměru |
| Poplatek za nesíťovou infrastrukturu | písm. s | Při dodávkách zákazníkům dle smlouvy SSDE |
| Kritéria udržitelnosti biomasy | písm. t | Biomasa a biokapaliny nad stanovenými prahovými výkony |

#### Vyloučení odpovědnosti za odchylku při dispečerském řízení (odst. 4)

Klíčové pravidlo chrání výrobce před finanční sankcí za odchylku, jejíž příčinou bylo dispečerské řízení podle § 26 odst. 5 — tedy situace, kdy dispečink sám dočasně změnil výrobu elektřiny ve výrobně. Finanční důsledky nese provozovatel soustavy (§ 26 odst. 6).

#### Kumulace rolí — výrobce + provozovatel úložiště + obchodník (odst. 5)
...
#### Nový subjekt transponující směrnici 2019/944

§ 23a byl do energetického zákona vložen v rámci transpozice směrnice 2019/944, konkrétně čl. 36–38 a čl. 54–56, které upravují postavení provozovatelů úložišť energie. Zařízení pro ukládání elektřiny (baterie, přečerpávací elektrárny, superkondenzátory apod.) jsou v zákoně definována v § 2 jako samostatná kategorie, odlišná od výroben elektřiny; úložiště elektřinu neprimárně nevyrábí, nýbrž ji přijímá, transformuje a vydává zpět.

#### Práva — paralela s výrobcem

Práva provozovatele úložiště (odst. 1) jsou konstruována analogicky s právy výrobce. Klíčový rozdíl: zatímco výrobce může dodávat elektřinu **ostatním účastníkům trhu** obecně (§ 23 odst. 1 písm. b), provozovatel úložiště může dodávat elektřinu z úložiště pouze **obchodníkovi s elektřinou, do zahraničí nebo na organizované trhy** (písm. b). Přímé dodávky konečným zákazníkům nejsou tedy pro provozovatele úložiště primárně určeny (na rozdíl od výrobce); to reflektuje charakter úložiště jako infrastrukturního prvku.
...
>
> *- b) obstarávat za nejnižší náklady podpůrné služby a elektřinu pro krytí ztrát elektřiny v přenosové soustavě a pro vlastní potřebu, nabízet a prodávat elektřinu obstaranou na krytí ztrát elektřiny a nevyužitou na krytí ztrát elektřiny v přenosové soustavě na vnitrodenním trhu s elektřinou; pro řízení rovnováhy mezi výrobou a spotřebou a pro řízení toků elektřiny podle odstavce 1 písm. c) obstarávat regulační energii,*
>
> *- c) omezit nebo přerušit v nezbytném rozsahu dodávku elektřiny účastníkům trhu s elektřinou v zákonem taxativně vymezených případech (body 1–10: ohrožení života, stav nouze, neoprávněný přenos/odběr, neumožnění přístupu k měření, plánované práce, poruchy, nebezpečná zařízení, zařízení ovlivňující kvalitu elektřiny, omezení od propojených soustav),*
>
> *- d) změnit nebo přerušit v nezbytném rozsahu dodávku elektřiny z výroben, ze zařízení pro ukládání elektřiny, přeshraniční výměnu elektřiny a dovoz nebo vývoz elektřiny v zákonem taxativně vymezených případech (body 1–11, obdobné důvody jako v písm. c), navíc dispečerské řízení podle § 26 odst. 5),*
>
...
>
> *- g) odstraňovat a oklešťovat stromoví a jiné porosty ohrožující bezpečné a spolehlivé provozování zařízení přenosové soustavy v případech, kdy tak po předchozím upozornění neučinil sám vlastník či uživatel,*
>
> *- h) vstupovat a vjíždět v souladu se zvláštními právními předpisy do uzavřených prostor orgánů Ministerstva obrany, Ministerstva vnitra, Ministerstva spravedlnosti, BIS a do obvodu dráhy a na nemovitosti se zvláštními zařízeními telekomunikací, v rozsahu nezbytném pro výkon licencované činnosti,*
>
...
>
> *(4) Provozovatel přenosové soustavy je povinen zřídit věcné břemeno umožňující využití cizí nemovitosti nebo její části pro účely uvedené v odstavci 3 písm. e), a to smluvně s vlastníkem nemovitosti za jednorázovou náhradu ve výši ceny zjištěné podle oceňovacího předpisu, pokud se strany nedohodnou jinak; při nedostupnosti vlastníka nebo neúspěchu dohody vydá vyvlastňovací úřad na návrh provozovatele přenosové soustavy rozhodnutí o zřízení věcného břemene.*
>
> *(5) V případech plánovaných prací (odst. 3 písm. c bod 6 a písm. d bod 6) je provozovatel přenosové soustavy povinen oznámit započetí a skončení omezení nebo přerušení dodávek elektřiny způsobem v místě obvyklým, nejméně však 50 dnů předem. V případě periodických zkoušek zařízení umožňujícího dispečerské řízení nejméně 3 pracovní dny předem.*
>
> *(6) V případech omezení nebo přerušení dodávky je provozovatel přenosové soustavy povinen obnovit dodávku elektřiny bezprostředně po odstranění příčin.*
>
> *(7) V případech omezení nebo přerušení dodávky je právo na náhradu škody vyloučeno; toto neplatí, nesplní-li provozovatel oznamovací povinnost nebo poruchu prokazatelně zavinil.*
>
> *(8) Provozovatel přenosové soustavy je povinen při výkonu oprávnění podle odst. 3 písm. e) až g) co nejvíce šetřit práv vlastníků dotčených nemovitostí, vstup oznámit, po skončení prací uvést nemovitosti do předchozího stavu a zajistit likvidaci klestu.*
>
> *(9) Pokud byl vlastník nebo uživatel nemovitosti v důsledku výkonu práv provozovatele přenosové soustavy omezen v obvyklém užívání nemovitosti nebo mu vznikla újma na majetku, má právo na přiměřenou jednorázovou náhradu. Právo na náhradu lze uplatnit do 2 let, jinak zaniká.*
>
> *(10) Provozovatel přenosové soustavy je dále povinen (povinnosti a–z): zajišťovat nediskriminační přístup a přenos, zřídit technický dispečink, měřit a předávat data OTE, zpracovávat a zveřejňovat Pravidla provozování přenosové soustavy po schválení ERÚ, spolupracovat s provozovateli jiných soustav, informovat ministerstvo a ERÚ o omezení dovozu nebo vývozu elektřiny, zpracovávat roční a desetiletý plán rozvoje přenosové soustavy a zveřejňovat jej, průběžně zveřejňovat informace o možnostech přenosu, provádět hodnocení provozu, účtovat odděleně za přenos a systémové služby, zpracovávat podklady pro cenová rozhodnutí ERÚ, zajišťovat ochranu chráněných informací, vypracovat havarijní plány, dodržovat stanovenou kvalitu dodávek a vykazovat ji ERÚ, informovat ministerstvo o fyzikálních tocích dovozu ze třetích zemí (do 2. týdne měsíce po čtvrtletí), zpracovávat zprávu o kvalitě údržby, poskytovat součinnost OTE při vnitrodenním trhu, zaregistrovat se u OTE do 30 dnů od licence, registrovat předávací místa u OTE, zajistit neznevýhodňující podmínky pro poskytovatele podpůrných služeb.*
>
> *(11) Provozovatel přenosové soustavy je dále povinen (povinnosti a–h): nezneužívat chráněné informace o třetích osobách při obchodech podniku ve skupině, zajistit, aby chráněné informace a zaměstnanci nebyli přeneseni k výrobci nebo obchodníkovi, bezplatně poskytovat měřená data na vyžádání (do 6 pracovních dnů, za posledních 36 měsíců), hradit datovému centru cenu za jeho činnost, stanovit normu spolehlivosti po projednání s ERÚ, spolupracovat s regionálním koordinačním centrem, zpracovávat zprávu o očekávané spotřebě elektřiny a plynu, zpracovávat zprávu o potřebách flexibility.*
>
> *(12) Nelze-li připojit výrobnu elektřiny nebo zařízení pro ukládání elektřiny z důvodu prokazatelného nedostatku kapacity, umožní provozovatel přenosové soustavy připojení s možností omezení využití rezervovaného výkonu bez náhrady za takové omezení při předcházení nebo řešení přetížení, neohrozí-li takové připojení bezpečný a spolehlivý provoz přenosové soustavy.*
>
> *(13) Provozovatel přenosové soustavy je povinen zpracovávat technické požadavky a podmínky obstarávání podpůrných služeb, projednat je s účastníky trhu a předložit ERÚ ke schválení. ERÚ je schválí, pokud umožňují neznevýhodňující nabízení těchto služeb. Provozovatel přenosové soustavy může technické požadavky zahrnout do Pravidel provozování přenosové soustavy.*
>
> *(14) Provozovatel přenosové soustavy je oprávněn obstarávat nefrekvenční podpůrné služby přímým nákupem od poskytovatele pouze s povolením ERÚ; ERÚ povolení udělí, prokáže-li provozovatel přenosové soustavy, že soutěžní postup není technicky možný nebo by vedl k vyšším nákladům.*
>
> *(15) Provozovatel přenosové soustavy nesmí odmítnout připojení výrobny elektřiny nebo zařízení pro ukládání elektřiny z důvodu možného nedostatku kapacity, který by teprve mohl vzniknout, nebo z důvodu vzniku dodatečných nákladů na nezbytné zvyšování kapacity.*
>
> *(16) Provozovatel přenosové soustavy vykonává činnosti zpřístupňování údajů z měření podle Nařízení o požadavcích na interoperabilitu ve vztahu k účastníkům trhu s elektřinou, se kterými sjednal smlouvu o připojení nebo smlouvu o zajištění služby přenosové soustavy, a to v rozsahu, v jakém provádí měření a zpracovává údaje z měření.*

**Výklad:**

#### Základní funkce provozovatele přenosové soustavy (odst. 1)

Provozovatel přenosové soustavy (v České republice výhradně ČEPS, a.s.) plní pět klíčových funkcí vymezených v odst. 1: (i) bezpečný, spolehlivý a efektivní provoz, obnova a rozvoj přenosové soustavy při využití energeticky účinných technologií; (ii) poskytování přenosové služby; (iii) řízení toků elektřiny; (iv) zajišťování systémových služeb; (v) účast ve vyrovnávacím mechanismu mezi provozovateli přenosových soustav (kompenzace za přeshraniční toky dle nařízení 2019/943).

Písm. a výslovně ukládá spolupráci na **integraci vnitřního evropského trhu s elektřinou** — jde o transpozici čl. 40 odst. 1 písm. f) směrnice 2019/944 a je základem zapojení ČEPS do struktury ENTSO-E (Evropská síť provozovatelů přenosových soustav elektrizačních soustav) a regionálních koordinačních center.

#### Licenční exkluzivita a zákaz vertikální integrace (odst. 2)

Odst. 2 zakotvuje **licenční exkluzivitu**: provozovatel přenosové soustavy smí být držitelem pouze licence na přenos elektřiny. Žádná jiná licence dle § 4 energetického zákona mu být udělena nesmí. Toto pravidlo spolu s § 24a (vlastnické oddělení) a § 24 odst. 11 (informační bariéry) tvoří trojici nástrojů unbundlingu na úrovni přenosové soustavy.

#### Práva v oblasti nemovitostí a sítí (odst. 3 písm. e–h)

Zákon přiznává provozovateli přenosové soustavy **zákonná věcná práva** k cizím nemovitostem: právo zřizovat zařízení přenosové soustavy, přetínat nemovitosti, vstupovat, vjíždět, odstraňovat porosty. Tato práva jsou ve své podstatě veřejnoprávním omezením vlastnictví odůvodněným veřejným zájmem na bezpečné dodávce elektřiny. Zákon výslovně ukládá šetřit práva vlastníků a uvést nemovitosti do původního stavu (odst. 8), a při omezení v obvyklém užívání přiznává vlastníkovi nárok na jednorázovou náhradu s prekluzivní lhůtou 2 let (odst. 9).

#### Zákonný zákaz odpovědnosti za škodu a jeho výjimky (odst. 7)

Zákon v odst. 7 vylučuje nárok na náhradu škody způsobené omezením nebo přerušením dodávky elektřiny v zákonem předvídaných situacích. Výjimka nastupuje ve dvou případech: (1) provozovatel nesplnil oznamovací povinnost 50 dnů (resp. 3 pracovní dny) předem; (2) poruchu prokazatelně zavinil sám provozovatel. Toto rozložení rizik vychází z charakteru veřejné infrastruktury a je standardní v evropském regulatorním prostředí.

#### Desetiletý plán rozvoje a spolupráce s regionálním koordinačním centrem (odst. 10 písm. j, odst. 11 písm. f)

Provozovatel přenosové soustavy zpracovává každý druhý rok desetiletý plán rozvoje přenosové soustavy, schvalovaný ERÚ. Zákon výslovně ukládá spolupráci s regionálním koordinačním centrem (RCC) zřízeným dle nařízení 2019/943 a zohledňování jeho doporučení. Cenová regulace podpůrných služeb a systémových služeb je sdílena s ERÚ (podklady dle odst. 10 písm. n); tarify stanoví ERÚ v regulatorním rámci.

#### Nefrekvenční podpůrné služby — podmíněné oprávnění k přímému nákupu (odst. 14)

Zákon preferuje tržní pořizování nefrekvenčních podpůrných služeb (výběrové řízení, aukce). Přímý nákup bez soutěže je možný jen s povolením ERÚ a jen za prokázaných podmínek (technická nemožnost soutěže nebo vyšší náklady soutěže). Toto pravidlo transponuje čl. 40 odst. 5 směrnice 2019/944 a má zabránit protisoutěžnímu chování na trhu s podpůrnými službami.

#### Zákaz odmítnutí připojení pro hypotetický budoucí nedostatek kapacity (odst. 15)
...
>
> *- b) nad provozovatelem přenosové soustavy nebo nad jeho obchodním závodem nevykonává přímo ani nepřímo kontrolu osoba nebo skupina osob jednajících ve shodě, která vykonává kontrolu nad výrobcem elektřiny, provozovatelem zařízení pro ukládání elektřiny, výrobcem plynu, obchodníkem s elektřinou nebo obchodníkem s plynem, nebo vyrábí elektřinu nebo plyn, ukládá elektřinu nebo obchoduje s elektřinou nebo s plynem,*
>
> *- c) ve vztahu k provozovateli přenosové soustavy neuplatňuje jakékoliv jiné právo osoba nebo skupina osob jednajících ve shodě, která vykonává kontrolu nad výrobcem elektřiny, provozovatelem zařízení pro ukládání elektřiny, výrobcem plynu, obchodníkem s elektřinou nebo obchodníkem s plynem,*
>
> *- d) provozovatel přenosové soustavy sám nebo jednáním ve shodě s jinými osobami nevykonává přímo ani nepřímo kontrolu nad výrobcem elektřiny, provozovatelem zařízení pro ukládání elektřiny nebo výrobcem plynu nebo nad obchodníkem s elektřinou nebo obchodníkem s plynem, ani ve vztahu k nim neuplatňuje jiné právo, a nevyrábí elektřinu nebo plyn, neukládá elektřinu nebo neobchoduje s elektřinou nebo s plynem,*
>
> *- e) členy statutárního orgánu, dozorčí rady, správní rady nebo jiného orgánu provozovatele přenosové soustavy určeného stanovami není oprávněna jmenovat, volit nebo jinak ustanovit osoba nebo skupina osob jednajících ve shodě, která vykonává kontrolu nad výrobcem elektřiny, provozovatelem zařízení pro ukládání elektřiny, výrobcem plynu, obchodníkem s elektřinou nebo obchodníkem s plynem,*
>
> *- f) členem statutárního orgánu, dozorčí rady, správní rady nebo jiného orgánu provozovatele přenosové soustavy určeného stanovami nesmí být osoba, která je členem dozorčí rady, správní rady, statutárního orgánu nebo jiného orgánu výrobce elektřiny, provozovatele zařízení pro ukládání elektřiny, výrobce plynu, obchodníka s elektřinou nebo obchodníka s plynem.*
>
> *(3) Je-li osobou nebo jednou z osob podle odstavce 2 písm. b), c) nebo e) Česká republika, územní samosprávný celek nebo jiná osoba veřejného práva, nepovažují se za tutéž osobu dva odlišné státní orgány nebo orgány ÚSC, z nichž jedna vykonává kontrolu nebo jiné právo nad provozovatelem přenosové soustavy a druhá nad výrobcem elektřiny, provozovatelem zařízení pro ukládání elektřiny nebo výrobcem plynu nebo obchodníkem s elektřinou nebo obchodníkem s plynem. Státní orgán nebo orgán ÚSC vykonávající kontrolu nad výrobcem nebo obchodníkem musí být nezávislý na státním orgánu nebo orgánu ÚSC vykonávajícím kontrolu nad provozovatelem přenosové soustavy.*
>
> *(4) Podmínky nezávislosti podle odstavce 2 se považují za splněné i tehdy, jestliže se provozovatel přenosové soustavy účastní na založení právnické osoby za účelem provozování přenosových soustav v jednom nebo více státech nebo v takové osobě získá účast, a přenechá takové osobě přenosovou soustavu k jejímu provozování společně s dalšími přenosovými soustavami. To neplatí, pokud by se na podnikání takové právnické osoby účastnily jiné osoby, které nebyly příslušnými orgány členských států určeny jako vlastnicky oddělení provozovatelé nebo nezávislí provozovatelé přenosových soustav.*
>
...
>
> *(6) Jiným právem podle odstavců 2 a 3 se rozumí zejména a) právo vykonávat hlasovací právo, b) vlastnické právo k podílům, u nichž souhrnná výše vkladů přesahuje 50 % základního kapitálu, nebo c) právo jmenovat, volit nebo jinak ustanovit do funkce nebo z ní odvolat člena voleného orgánu nebo možnost toto ustanovení do funkce nebo odvolání z ní prosadit.*

**Výklad:**

#### Model vlastnického oddělení (full ownership unbundling)

§ 24a transponuje čl. 43–47 směrnice 2019/944 (v návaznosti na starší směrnici 2009/72/ES) a zavádí nejpřísnější model unbundlingu — **vlastnické oddělení** (full ownership unbundling). Zákon ukládá, aby provozovatel přenosové soustavy byl vlastníkem přenosové soustavy (odst. 2 písm. a) a aby byl zcela oddělen od výrobních a obchodních aktivit ve čtyřech dimenzích:

| Dimenze | Zákaz |
|---|---|
| Kapitálová | Výrobce/obchodník nesmí kontrolovat provozovatele přenosové soustavy ani vlastnit většinový podíl |
| Personální (statutární orgány) | Průnik v členství ve statutárních nebo dozorčích orgánech je zakázán |
| Informační | Chráněné informace nesmějí být přeneseny k výrobci/obchodníkovi (§ 24 odst. 11) |
| Provozní | Provozovatel přenosové soustavy nesmí vykonávat kontrolu nad výrobcem/obchodníkem |

#### Výjimka pro veřejnoprávní vlastníky (odst. 3)

Zákon výslovně řeší situaci, kdy státní subjekty nebo územně samosprávné celky jsou na obou stranách — jak jako kontrolující osoby nad provozovatelem přenosové soustavy, tak jako kontrolující osoby nad výrobcem nebo obchodníkem. V takovém případě platí, že **dva odlišné státní orgány nebo orgány ÚSC nejsou totožnou osobou**, pokud jsou na sobě navzájem nezávislé. Tato výjimka byla klíčová pro českou situaci, kdy stát vlastní jak ČEPS (provozovatel přenosové soustavy) prostřednictvím ČEZ, a.s., tak ČEZ, a.s. samotný (výrobce elektřiny).

> **Poznámka k formátu zdrojového textu:** V § 24a odst. 6 zdrojový soubor obsahuje wikilinky `[[#§ 3|3]]` — jedná se o interní Obsidian odkaz na nadpis § 3 v rámci dokumentu, nikoliv na jiný zákon; jde o artefakt formátování zdrojového souboru bez normativního dopadu.
...
>
> *- c) omezit nebo přerušit v nezbytném rozsahu dodávku elektřiny účastníkům trhu s elektřinou v zákonem taxativně vymezených případech (body 1–9: ohrožení života, stav nouze, neoprávněná distribuce/odběr, plánované práce, poruchy, nebezpečná zařízení, zařízení ovlivňující kvalitu elektřiny, opakované neumožnění přístupu k měřicímu zařízení po písemné výzvě),*
>
> *- d) změnit nebo přerušit v nezbytném rozsahu dodávku elektřiny z výroben, ze zařízení pro ukládání elektřiny a dovoz nebo vývoz elektřiny s ohledem na spolehlivý provoz distribuční soustavy v zákonem taxativně vymezených případech (body 1–11),*
>
> *- e) v souladu se zvláštním právním předpisem zřizovat a provozovat na cizích nemovitostech zařízení distribuční soustavy, přetínat tyto nemovitosti vodiči a umísťovat v nich vedení,*
>
> *- f) vstupovat a vjíždět na cizí nemovitosti v souvislosti se zřizováním, obnovou a provozováním distribuční soustavy,*
>
> *- g) odstraňovat a oklešťovat stromoví a jiné porosty ohrožující bezpečné a spolehlivé provozování zařízení distribuční soustavy v případech, kdy tak po předchozím upozornění neučinil sám vlastník či uživatel,*
>
> *- h) vstupovat nebo vjíždět v souladu se zvláštními právními předpisy do uzavřených prostor orgánů Ministerstva obrany, Ministerstva vnitra, Ministerstva spravedlnosti, BIS a do obvodu dráhy, jakož i vstupovat nebo vjíždět na nemovitosti se zvláštními zařízeními telekomunikací, v rozsahu a způsobem nezbytným pro výkon licencované činnosti,*
>
> *- i) na naměřené a vyhodnocené údaje o dodávkách a odběrech elektřiny a naměřené a vyhodnocené údaje se zohledněním sdílené elektřiny v předávacích místech přiřazených do skupiny sdílení od datového centra,*
>
> *- j) zrušit rezervaci výkonu nebo rezervaci příkonu, pokud žadatel o připojení prokazatelně neplní podmínky a termíny připojení,*
>
...
>
> *(4) Provozovatel distribuční soustavy je povinen zřídit věcné břemeno umožňující využití cizí nemovitosti nebo její části pro účely uvedené v odstavci 3 písm. e) za jednorázovou náhradu, při nedostupnosti vlastníka rozhodne vyvlastňovací úřad.*
>
> *(5) V případech plánovaných prací je provozovatel distribuční soustavy povinen oznámit zahájení a skončení omezení nebo přerušení dodávek elektřiny způsobem v místě obvyklým nebo s využitím elektronických komunikací, nejméně 15 dnů předem; u periodických zkoušek dispečerského zařízení nejméně 3 pracovní dny předem. Ohlašovací povinnost nevzniká při nutných provozních manipulacích, při nichž omezení nebo přerušení dodávky elektřiny nepřekročí 20 minut.*
>
> *(6) V případech omezení nebo přerušení je provozovatel distribuční soustavy povinen obnovit dodávku bezprostředně po odstranění příčin; v případech neoprávněného odběru nebo neoprávněné dodávky do soustavy po úhradě náhrady škody.*
>
> *(7) V případech omezení nebo přerušení je právo na náhradu škody vyloučeno; toto neplatí, nesplní-li provozovatel oznamovací povinnost nebo poruchu prokazatelně zavinil.*
>
> *(8) Provozovatel distribuční soustavy je povinen při výkonu oprávnění podle odstavce 3 písm. e) až g) co nejvíce šetřit práv vlastníků dotčených nemovitostí, vstup bezprostředně oznámit, po skončení prací uvést nemovitosti do předchozího stavu a zajistit likvidaci klestu.*
>
> *(9) Pokud byl vlastník nebo uživatel nemovitosti omezen v obvyklém užívání nebo mu vznikla újma na majetku v důsledku výkonu práv provozovatele distribuční soustavy, má právo na přiměřenou jednorázovou náhradu. Právo na náhradu lze uplatnit do 2 let, jinak zaniká.*
>
> *(10) Provozovatel distribuční soustavy je dále povinen (povinnosti a–y): zajistit každému připojení a distribuci, na žádost obchodníka nebo výrobce přerušit distribuci při neoprávněném odběru, zajišťovat neznevýhodňující podmínky pro připojení a distribuci, zajistit technický dispečink nebo řídicí a dohledové centrum, zajišťovat měření a předávat data OTE a datovému centru, zpracovávat a zveřejňovat Pravidla provozování distribuční soustavy po schválení ERÚ, poskytovat informace provozovateli přenosové soustavy a jiným provozovatelům distribučních soustav, zpracovávat přípravy provozu distribuční soustavy, zpracovávat každé 2 roky plán rozvoje regionální distribuční soustavy na 5–10 let a předložit jej ERÚ do 30. června, průběžně zveřejňovat informace o možnostech distribuce, provádět hodnocení provozu, zpracovávat podklady pro cenová rozhodnutí ERÚ, zajišťovat ochranu chráněných informací, vypracovat havarijní plány, dodržovat stanovenou kvalitu dodávek a vykazovat ji ERÚ, zajistit připojení svého zařízení k jiné distribuční soustavě a k přenosové soustavě, poskytnout dodavateli poslední instance údaje o zákazníkovi, nezneužívat chráněné informace, bezplatně poskytovat měřená data zákazníkovi nebo jím určené osobě (do 6 pracovních dnů, za posledních 36 měsíců), bezplatně umožnit zákazníkovi s inteligentním měřičem přístup k datům do 15 minut od naměření, spolupracovat s provozovateli dobíjecích stanic, umožnit poskytování flexibility a výkonové rovnováhy.*
>
> *(11) Provozovatel distribuční soustavy je rovněž povinen: informovat ministerstvo o fyzikálních tocích dovozu elektřiny ze třetích zemí, zpracovávat a předávat OTE typové diagramy dodávek a potřebné údaje, zpracovávat a předávat ministerstvu a ERÚ ročně do 1. března zprávu o kvalitě a úrovni údržby zařízení distribuční soustavy, zaregistrovat se u OTE do 30 dnů od licence, řídit se pokyny technického dispečinku provozovatele přenosové soustavy nebo nadřazeného provozovatele distribuční soustavy, zajistit přenos nebo distribuci elektřiny pro připojenou poddistribuční soustavu, provést technická opatření k ochraně ptactva na nových stožárech VN, zajišťovat propagaci energetických služeb zákazníkům, při změně parametrů elektřiny upravit svá zařízení, zajistit si dodávku elektřiny na krytí ztrát, hradit OTE ceny za jeho činnosti, registrovat předávací místa u OTE, zveřejňovat a aktualizovat interaktivní mapu volné kapacity, hradit datovému centru cenu za jeho činnost (regionální distribuční soustavy), vyhodnocovat celkový potenciál flexibility na straně výroby i spotřeby nejméně jednou za 4 roky.*
>
...
>
> *(13) Nelze-li připojit výrobnu elektřiny nebo zařízení pro ukládání elektřiny z důvodu prokazatelného nedostatku kapacity zařízení pro distribuci, umožní provozovatel distribuční soustavy připojení s možností omezení využití rezervovaného výkonu bez náhrady za takové omezení při předcházení nebo řešení přetížení, neohrozí-li takové připojení bezpečný a spolehlivý provoz distribuční soustavy.*
>
> *(14) Provozovatel distribuční soustavy je povinen plán rozvoje regionální distribuční soustavy před předložením ERÚ projednat s účastníky trhu. ERÚ zveřejní plán rozvoje. Pokud plán neobsahuje stanovené náležitosti nebo má jiné vady, uloží ERÚ rozhodnutím povinnost změny a určí přiměřenou lhůtu. Nezahájí-li ERÚ řízení o změně do 2 měsíců od předložení, platí, že plán je úplný a bez vad.*
>
> *(15) Provozovatel distribuční soustavy je povinen zpracovávat technické požadavky a podmínky obstarávání nefrekvenčních podpůrných služeb a flexibility, projednat je s účastníky trhu a předložit ERÚ ke schválení. ERÚ je schválí, pokud umožňují neznevýhodňující nabízení těchto služeb.*
>
> *(16) Provozovatel distribuční soustavy je oprávněn obstarávat nefrekvenční podpůrné služby nebo flexibilitu přímým nákupem od poskytovatele těchto služeb pouze s povolením ERÚ.*
>
> *(17) Provozovatel distribuční soustavy umožní požádat o připojení odběrného místa, výrobny elektřiny, zařízení pro ukládání elektřiny nebo zařízení distribuční soustavy a předložit příslušné dokumenty výhradně v elektronické podobě.*
>
> *(18) Provozovatel distribuční soustavy vykonává činnosti zpřístupňování údajů z měření podle Nařízení o požadavcích na interoperabilitu ve vztahu k účastníkům trhu s elektřinou, se kterými sjednal smlouvu o připojení nebo smlouvu o zajištění služby distribuční soustavy, v rozsahu, v jakém provádí měření a zpracovává údaje z měření.*
...
#### Oznamovací lhůta 15 dnů (vs. 50 dnů u přenosové soustavy) a výjimka pro nutné manipulace (odst. 5)

Zákon stanoví pro distribuční soustavu kratší oznamovací lhůtu (15 dnů) než pro přenosovou soustavu (50 dnů), což odráží menší dopad distribuční přerušení. Zákon výslovně vylučuje ohlašovací povinnost při nutných provozních manipulacích, při nichž přerušení nepřekročí **20 minut** — tím se eliminuje administrativní zátěž při krátkých technologicky nezbytných výpadcích.

#### Plán rozvoje regionální distribuční soustavy — 2leté zpracování a přezkum ERÚ (odst. 10 písm. j, odst. 14)

Regionální distributor zpracovává každé 2 roky plán rozvoje na 5–10 let a předkládá jej ERÚ do 30. června. ERÚ má 2měsíční lhůtu k zahájení řízení o vadách; nevyužije-li ji, nastupuje fikce úplnosti a bezvadnosti plánu. Tato procedura zajišťuje regulatorní dohled nad investičními záměry bez nadměrné byrokratické zátěže.

#### Interaktivní mapa volné kapacity — nová povinnost transparentnosti (odst. 11 písm. m)

Zákon ukládá provozovatelům distribučních soustav zveřejňovat a jednou měsíčně aktualizovat interaktivní mapu volné kapacity — pro napěťové hladiny VVN a VN údaje o volné distribuční kapacitě, pro NN údaje o volné kapacitě elektrických stanic. Tato povinnost — zavedená novelou přijatou v rámci balíčku čistá energie — je klíčovým nástrojem pro plánování připojení nových výroben, úložišť a dobíjecích stanic.

#### Elektronická podání povinná (odst. 17)
...
>
> *- a) osoby odpovědné za řízení provozovatele distribuční soustavy se nesmí přímo ani nepřímo podílet na organizačních strukturách vertikálně integrovaného podnikatele odpovědného za běžný provoz výroby elektřiny, ukládání elektřiny, přenosu elektřiny a obchodu s elektřinou nebo plynem; člen statutárního orgánu nebo vedoucí zaměstnanec provozovatele distribuční soustavy nemůže být fyzická osoba, která je současně statutárním orgánem nebo vedoucím zaměstnancem držitele licence na výrobu elektřiny, ukládání elektřiny, přenos elektřiny, obchod s elektřinou nebo plynem v rámci téhož vertikálně integrovaného podnikatele,*
>
> *- b) musí být přijata veškerá vhodná opatření, aby k profesionálním zájmům členů statutárního orgánu nebo vedoucích zaměstnanců provozovatele distribuční soustavy bylo přihlíženo způsobem zajišťujícím jejich nezávislé jednání; odměňování nesmí být závislé na hospodářských výsledcích ostatních držitelů licencí v rámci téhož vertikálně integrovaného podnikatele,*
>
> *- c) provozovatel distribuční soustavy musí disponovat skutečnými rozhodovacími právy ve vztahu k majetku nezbytnému k provozování, údržbě a rozvoji distribuční soustavy, nezávislými na vertikálně integrovaném podnikateli; mateřská společnost nesmí udělovat pokyny ohledně běžného provozu nebo zasahovat do rozhodování o výstavbě či modernizaci částí distribuční soustavy, pokud takové rozhodnutí nepřekračuje schválený finanční plán.*
>
> *(3) Provozovatel distribuční soustavy musí přijmout vnitřním předpisem program rovného zacházení k vyloučení diskriminačního chování, kterým stanoví a) opatření k vyloučení diskriminačního jednání ve vztahu k účastníkům trhu s elektřinou mimo skupinu provozovatele a b) povinnosti a práva zaměstnanců ke splnění účelů programu.*
>
> *(4) Provozovatel distribuční soustavy jmenuje nebo jinak obsazuje auditora programu. Provozovatel distribuční soustavy je povinen zajistit, aby auditor programu měl vytvořeny podmínky pro nezávislý výkon své funkce, zejména dostatečné pravomoci a materiální a organizační podmínky. Způsob odměňování auditora programu nesmí být na újmu nezávislého výkonu jeho funkce.*
>
> *(5) Auditor programu je povinen dohlížet na provádění programu rovného zacházení a zpracovávat a předkládat do 30. dubna následujícího kalendářního roku ERÚ a ministerstvu výroční zprávu o opatřeních přijatých k provádění programu rovného zacházení za uplynulý rok a zároveň ji zveřejňovat na svých internetových stránkách.*
>
...
>
> *(8) Pokud je povinnost oddělení činností provedena pachtem obchodního závodu nebo jeho části, je pachtýř povinen převzít propachtovaný obchodní závod nebo jeho část do svého účetnictví. Pokud je povinnost oddělení provedena pachtem jednotlivého majetku, je propachtovatel povinen sdělit pachtýři informace o hodnotě propachtovaného majetku v rozsahu požadovaném ERÚ pro účely cenové regulace.*
>
...
#### Funkční unbundling — méně přísný než vlastnické oddělení

§ 25a transponuje čl. 35 směrnice 2019/944 a zavádí **funkční oddělení** (functional unbundling) pro provozovatele distribučních soustav v rámci vertikálně integrovaných skupin. Na rozdíl od vlastnického oddělení (§ 24a) zde **není požadováno oddělení vlastnictví majetku** — distribuční soustava může vlastnicky zůstat součástí skupiny. Oddělení se týká právní formy, organizace a rozhodování.

Povinnost platí od 1. 1. 2007 a vztahuje se na provozovatele distribučních soustav s více než 90 000 odběrnými místy (odst. 9). Menší provozovatelé jsou od těchto požadavků exemptováni.

#### Program rovného zacházení a auditor (odst. 3–5)

Zákon ukládá dvojí mechanismus compliance: (i) **program rovného zacházení** jako vnitřní předpis — klíčový nástroj prevence diskriminace zákazníků nebo výrobců mimo skupinu; (ii) **auditor programu** jako nezávislý interní kontrolor, jehož výroční zpráva jde přímo ERÚ a ministerstvu. Auditor musí být nezávislý — jeho odměňování nesmí být ovlivněno výsledky skupiny. Zákon výslovně stanoví povinnost provozovatele distribuce **seznámit** s programem rovného zacházení všechny zaměstnance a orgány společnosti.

#### Zákaz podílů vedoucích osob v jiných subjektech skupiny (odst. 6)

Vedoucí zaměstnanci a členové statutárního orgánu provozovatele distribuce nesmějí držet podíly převyšující **1 % základního kapitálu** v jiné licencované osobě v rámci téhož vertikálně integrovaného podnikatele. Jde o antikorupční a antikonfliktní pravidlo doplňující personální inkompatibilitu dle odst. 2 písm. a.

#### Pacht obchodního závodu a cenová regulace (odst. 8)
...
>
> *(2) Energetický regulační úřad rozhoduje o udělení povolení na žádost provozovatele přenosové soustavy nebo provozovatele distribuční soustavy. Energetický regulační úřad povolení udělí, jestliže provozovatel prokáže, že zařízení pro ukládání energie je plně integrovaným prvkem soustavy nebo má být jako plně integrovaný prvek soustavy používáno pro potřeby přenosové nebo distribuční soustavy. Energetický regulační úřad udělí povolení pro jedno nebo více zařízení nebo zařízení vymezené typem nebo počtem nebo velikostí instalovaného výkonu zařízení pro ukládání energie. ERÚ může současně stanovit podmínky, za kterých povolení uděluje, zejm. dobu platnosti povolení nebo způsob využití zařízení při provozu nebo řízení soustavy.*
>
> *(3) Provozovatel přenosové soustavy nebo provozovatel distribuční soustavy nesmí dodávat elektřinu ze zařízení pro ukládání energie jinému účastníkovi trhu s elektřinou, ukládat elektřinu pro jiného účastníka trhu s elektřinou, poskytovat podpůrné služby nebo flexibilitu ani využívat jím provozované zařízení pro ukládání energie jako náhradu služeb pro zajišťování výkonové rovnováhy nebo řízení přetížení podle čl. 13 Nařízení o vnitřním trhu s elektřinou.*
>
...
>
> *(6) Provozovatel jiné než regionální distribuční soustavy může vlastnit, vyvíjet, spravovat nebo provozovat zařízení pro ukládání energie, které není plně integrovaným prvkem soustavy, nebo veřejně přístupnou dobíjecí stanici pro elektrická vozidla pouze s povolením ERÚ, prokáže-li splnění podmínek pro průmyslové nebo uzavřené distribuční soustavy (distribuce v průmyslové/obchodní zóně, zanedbatelný podíl spotřebitelů, provozní či výrobní propojenost zákazníků nebo distribuce elektřiny vlastníkovi/provozovateli soustavy nebo členům seskupení).*
>
> *(7) Provozovatel přenosové soustavy nebo provozovatel distribuční soustavy je povinen bez zbytečného odkladu oznámit ERÚ změnu skutečností, na jejichž základě mu bylo uděleno povolení.*
>
> *(8) ERÚ povolení zruší, pokud zjistí, že provozovatel přestal splňovat podmínky pro udělení povolení.*
>
...
#### Zásada zákazu vlastnictví úložišť energetickými sítaři — plně integrované prvky jako výjimka

§ 25b transponuje čl. 36 směrnice 2019/944. Obecné pravidlo zakazuje provozovatelům přenosové a distribučních soustav vlastnit nebo provozovat zařízení pro ukládání energie. Zákon zavádí dvě výjimky:

1. **Vlastní potřeba nesouvisející s provozováním soustavy** — zařízení sloužící čistě interním provozním potřebám (např. záložní zdroje UPS pro IT systémy) nevyžadují povolení.
2. **Plně integrovaný prvek soustavy** — zařízení technicky integrované do soustavy jako její nezbytná součást (typicky akumulátory sloužící frekvenční regulaci nebo řízení napětí v dané části sítě); na tato zařízení se vztahuje licenční exkluzivita a ERÚ uděluje povolení.

Zákon zakazuje, aby síťař dodával elektřinu z povoleného úložiště jiným účastníkům trhu nebo je využíval jako komerční subjekt — úložiště smí plnit pouze funkce plně integrovaného prvku (odst. 3).

#### Dobíjecí stanice — rozdílný regime pro regionální a jiné distribuční soustavy (odst. 5–6)

Regionální provozovatel distribuční soustavy **nesmí vlastnit ani provozovat veřejně přístupné dobíjecí stanice** pro elektrická vozidla (definované zákonem o pohonných hmotách). Smí však vlastnit neveřejné dobíjecí stanice (např. v technologických areálech). Provozovatel jiné než regionální distribuční soustavy (místní, průmyslová soustava) může vlastnit i veřejně přístupné dobíjecí stanice nebo neintegrovaná úložiště, pokud splní podmínky dle odst. 6 a získá povolení ERÚ.
...
>
> *(5) Technický dispečink provozovatele přenosové soustavy a technické dispečinky a řídicí a dohledová centra provozovatelů distribučních soustav jsou v případě ohrožení bezpečného a spolehlivého provozu elektrizační soustavy a po využití sjednaných možností omezování využití rezervovaných výkonů výroben elektřiny a poté dostupných tržních mechanismů provozovatelem přenosové soustavy oprávněny za účelem odstraňování nevyrovnané bilance elektrizační soustavy nebo její části, nebo za účelem řízení přetížení při dispečerském řízení v nezbytné míře dočasně měnit výrobu elektřiny ve výrobnách elektřiny a dodávku elektřiny do nebo ze zařízení pro ukládání elektřiny. Omezení výroby elektřiny ve výrobnách s kombinovanou výrobou elektřiny a tepla může být prováděno nejvýše v rozsahu neohrožujícím dodávky tepelné energie.*
>
...
>
> *- a) příslušnému výrobci elektřiny z obnovitelných zdrojů, který je příjemcem podpory, při omezení výroby elektřiny náhradu za neodebranou elektřinu ve výši odpovídající celkovému příjmu výrobce po odečtu nákladů za nevyrobenou elektřinu, kterého by dosáhl v případě neomezení výroby, nebo*
>
> *- b) příslušnému výrobci elektřiny náhradu za změnu výroby elektřiny, s výjimkou případů podle písmene a), ve výši sjednané ve smlouvě nebo stanovené podle Nařízení o vnitřním trhu s elektřinou.*
>
...
#### Hierarchie dispečerského řízení — řetězec příkazů

§ 26 zavádí **hierarchii dispečerského řízení** v elektrizační soustavě. Na vrcholu hierarchie stojí technický dispečink provozovatele přenosové soustavy (ČEPS): jeho pokyny jsou závazné pro technické dispečinky všech distribučních soustav (odst. 4 písm. a). Mezi distribučními soustavami platí přímá nadřazenost dispečinku nadřazené soustavy (odst. 4 písm. b); dispečinky soustav na stejné úrovni bez přímého propojení si jsou rovnocennými partnery a spolupracují (odst. 4 písm. c).

#### Zákonné zmocnění k redispatchingu — předpoklady a pořadí opatření (odst. 5)

Odst. 5 je klíčovým ustanovením pro **redispatch** (nucená změna výroby nebo ukládání elektřiny ze strany dispečinku). Zákon podmíňuje jeho uplatnění splněním pořadí opatření:

1. Ohrožení bezpečného a spolehlivého provozu elektrizační soustavy.
2. Vyčerpání sjednaných možností omezování rezervovaných výkonů.
3. Vyčerpání dostupných tržních mechanismů (regulační energie na trhu).

Teprve po splnění těchto podmínek je dispečink oprávněn dočasně a v nezbytné míře měnit výrobu nebo dodávku elektřiny do/ze zařízení pro ukládání. Omezení CHP výroben je limitováno tak, aby neohrozilo dodávky tepla — důležité pro soustavy zásobování teplem.

#### Náhrada za redispatch (odst. 6)

Odst. 6 stanoví povinnost provozovatele soustavy poskytnout výrobci **náhradu** za nucené omezení výroby při dispečerském řízení mimo stav nouze. Zákon rozlišuje dvě situace: (a) výrobce OZE s podporou — náhrada ve výši celkového příjmu, jehož by bez omezení dosáhl (celkové krytí ztráty); (b) ostatní výrobci — náhrada dle smlouvy nebo nařízení 2019/943. Náhrada se neposkytuje při omezení, pro které bylo sjednáno připojení s výslovnou možností omezení bez náhrad (tzv. non-firm connection). V případě sporu o výši náhrady rozhoduje ERÚ jako arbitr.

#### Řízení napětí a jalového výkonu není omezení výroby (odst. 8)
...
>
> *(3) Účastník trhu s elektřinou, který je významným uživatelem sítě podle Nařízení, kterým se stanoví rámcový pokyn pro provoz elektroenergetických přenosových soustav, poskytovatel podpůrných služeb a poskytovatel flexibility jsou povinni se v rozsahu národního výcvikového plánu účastnit společného výcviku osob podílejících se na dispečerském řízení.*
...
>
> *(6) Zakazuje se a) přenechat akcie datového centra k užívání nebo požívání jiné osobě než uvedené v odstavci 1, b) převést práva spojená s akciemi datového centra na jinou osobu než uvedenou v odstavci 1, c) přenechat výkon práv spojených s akciemi datového centra jiné osobě než uvedené v odstavci 1.*
>
...
#### Datové centrum — nový energetický subjekt od roku 2024

§ 27 zakotvuje **datové centrum** jako nový typ regulovaného subjektu zavedený zákonem č. 131/2024 Sb. Datové centrum je infrastrukturní subjekt pověřený centralizovaným zpracováním, archivací a zpřístupňováním měřených dat z elektroenergetiky (data hub). Zákon vychází z nařízení EU č. 2022/... (Nařízení o požadavcích na interoperabilitu a postupech pro přístup k údajům z měření — tzv. Smart Metering/Metering Data Regulation).

#### Uzavřená akcionářská struktura — veřejnoprávní model

Zákon zavádí **uzavřenou akcionářskou strukturu**: akcie datového centra mohou vlastnit pouze provozovatel přenosové soustavy, regionální provozovatelé distribučních soustav s nejméně 100 000 odběrnými místy nebo Česká republika. Prahová hodnota 100 000 odběrných míst je vyšší než obecná hranice 90 000 (u unbundlingu), čímž se okruh povinných akcionářů zužuje na největší distributory. Při zakládání se akcionáři podílí na základním kapitálu rovným dílem.
...
>
> *- d) uzavřít smlouvu o přístupu do informačního systému datového centra s každým, kdo o to požádá, splní podmínky přístupu stanovené Řádem datového centra a komu tento zákon vůči datovému centru zakládá práva nebo povinnosti nebo komu ukládá povinnost zajistit předávání údajů mezi datovým centrem a jiným účastníkem trhu s elektřinou.*
>
> *(3) Datové centrum umožní každému, komu tento zákon nebo jiný právní předpis ukládá povinnost předávat nebo poskytovat údaje datovému centru, činit tak elektronicky prostřednictvím informačního systému datového centra, a to přímo, nebo prostřednictvím účastníka trhu s elektřinou s přístupem do informačního systému datového centra, se kterým povinná osoba uzavřela smlouvu o dodávce elektřiny nebo smlouvu o sdružených službách dodávky elektřiny, nebo prostřednictvím jiné osoby s přístupem do informačního systému datového centra pověřené povinnou osobou nebo členy skupiny sdílení.*
>
> *(4) Datové centrum je oprávněno vykonávat další činnosti odlišné od činností datového centra nebo vykonávaných podle jiného právního předpisu pouze s předchozím souhlasem ministerstva. Ministerstvo souhlas udělí, jestliže se nejedná o činnosti vyhrazené tímto zákonem jinému účastníkovi trhu s elektřinou a datové centrum prokáže, že výkon takových činností a) neohrozí řádné plnění zákonných povinností datového centra nebo nepovede k diskriminaci ostatních účastníků trhu s elektřinou a b) nenaruší nebo neomezí hospodářskou soutěž na trhu s elektřinou ani takové soutěži nebrání.*

**Výklad:**

#### Řád datového centra jako regulatorní nástroj

§ 27c ukládá datovému centru zpracovat **Řád datového centra** — vnitřní normativní dokument regulující podmínky přístupu do informačního systému datového centra. Řád podléhá schválení ERÚ, čímž je zajištěna jeho regulatorní přiměřenost. Datové centrum je povinno uzavřít smlouvu o přístupu do systému s každým oprávněným subjektem — povinnost uzavřít smlouvu je zákonná (ius contrahendi), nikoliv diskreční.

#### Výlučnost datových funkcí a podmíněnost vedlejších činností (odst. 4)
...
> *(2) Datové centrum je povinno*
>
> *- a) evidovat na žádost účastníka trhu s elektřinou registraci přiřazení předávacích míst do skupiny sdílení a předávat informace o registraci přiřazení operátorovi trhu, provozovateli distribuční soustavy, obchodníkovi s elektřinou a zákazníkovi, výrobci elektřiny nebo provozovateli zařízení pro ukládání elektřiny, jehož předávací místo je přiřazené do skupiny sdílení,*
>
...
#### Systém sdílení elektřiny ve společenství — registrace, průběhové měření, skupiny sdílení

§ 27e upravuje **sdílení elektřiny v rámci společenství** (energetická společenství a společenství pro obnovitelné zdroje dle § 20b). Sdílení je podmíněno: (i) **registrací skupiny sdílení** u datového centra; (ii) **průběhovým měřením** u všech předávacích míst ve skupině sdílení; (iii) **souhlasem člena** s přiřazením jeho předávacího místa. Registrace je ze zákona bezúplatná — datové centrum nesmí za samotný registrační úkon účtovat.

Každé předávací místo smí být přiřazeno jen do **jedné skupiny sdílení** bez ohledu na typ skupiny (ve společenství nebo mimo společenství). Tím zákon brání dvojímu zápočtu sdílené elektřiny.

#### Vyúčtování sdílené elektřiny — úplatné vs. bezúplatné sdílení (odst. 6)
...
>
> *- i) uzavřít smlouvu s 1. dynamickým určením ceny elektřiny pro dodávky elektřiny do odběrného místa, je-li odběrné místo vybaveno průběhovým měřením, 2. pevnou cenou dodávky elektřiny na dobu dodávky elektřiny alespoň jednoho roku,*
>
...
>
> *(5) Zákazník má právo provozovat v odběrném místě výrobnu elektřiny nebo zařízení pro ukládání elektřiny propojené s přenosovou soustavou nebo distribuční soustavou pouze v případě, že ve stejném odběrném místě není připojena jiná výrobna elektřiny nebo jiné zařízení pro ukládání elektřiny, jedná se o výrobnu elektřiny nebo zařízení pro ukládání elektřiny s instalovaným výkonem do 100 kW a pro jejich připojení byla uzavřena smlouva o připojení. Jedná-li se o výrobnu elektřiny nebo zařízení pro ukládání elektřiny s instalovaným výkonem do 10,8 kW, má zákazník právo je připojit a provozovat na základě oznámení provozovateli distribuční soustavy, pokud záměr připojit výrobnu elektřiny nebo zařízení pro ukládání elektřiny oznámí provozovateli distribuční soustavy na elektronický kontakt určený provozovatelem distribuční soustavy, při připojení výrobny elektřiny nebo zařízení pro ukládání elektřiny splní technické podmínky připojení stanovené provozovatelem distribuční soustavy, splnění těchto podmínek provozovateli distribuční soustavy doloží a provozovatel distribuční soustavy do 30 dnů od oznámení připojení neodmítne z důvodů, pro které je oprávněn odmítnout připojení podle § 25 odst. 10 písm. a). Splní-li zákazník podmínky, platí, že marným uplynutím lhůty se mění obsah závazku ze smlouvy o připojení odběrného místa zákazníka tak, že předmětem závazku je také připojení výrobny elektřiny nebo zařízení pro ukládání elektřiny s rezervovaným výkonem ve výši uvedené v oznámení, nejvýše však do hodnoty instalovaného výkonu. Provozovatel distribuční soustavy změnu obsahu závazku zákazníkovi bez zbytečného odkladu písemně potvrdí.*
>
> *(6) Zákazník, který provozuje výrobnu elektřiny nebo zařízení pro ukládání elektřiny podle odstavce 5, je povinen a) zajistit technická zařízení splňující požadavky bezpečnosti a spolehlivosti, b) zajistit, aby instalaci a provoz prováděly osoby s odbornou způsobilostí, c) vyrábět nebo ukládat elektřinu bez ohrožení života, zdraví, majetku nebo životního prostředí, d) řídit se pokyny dispečinku, e) dodržovat parametry kvality dodávané elektřiny, nejedná-li se o výrobnu nebo zařízení s technickým zamezením dodávky do distribuční soustavy, f) podílet se na úhradě nákladů provozovatele soustavy spojených s připojením.*
>
...
>
> *(10) Vlastník nemovitosti, do které je zákazníkům dodávána elektřina podle smlouvy, je povinen a) tuto dodávku zákazníkům umožnit, b) udržovat společnou domovní elektrickou instalaci ve stavu odpovídajícím právním předpisům a technickým normám, c) poskytovat technické údaje o společné domovní elektrické instalaci držiteli licence na distribuci elektřiny, d) umožnit držiteli licence na distribuci elektřiny přístup k této společné domovní instalaci.*
>
...
#### Právo na připojení a smluvní přístup k síti (odst. 1 písm. a, c)

Zákazník má právo na uzavření **smlouvy o připojení** a na fyzické připojení k přenosové nebo distribuční soustavě — podmíněné splněním technických a obchodních podmínek a souhlasem vlastníka dotčené nemovitosti. Právo na dopravu dohodnutého množství elektřiny do odběrného místa za regulovanou cenu (písm. c) zakládá subjektivní nárok zákazníka na distribuci nebo přenos, jehož cena je regulována ERÚ.

#### Právo na informace o energetickém mixu a dopadech na životní prostředí (odst. 1 písm. d)

Transponuje čl. 18 odst. 1 písm. c) směrnice 2019/944: zákazník má právo na informace o **celkové směsi paliv** dodavatele a o dopadech na životní prostředí (emise CO2, radioaktivní odpad). Tyto informace musí obchodník uvádět ve vyúčtování a zveřejňovat.

#### Právo na bezplatnou volbu a změnu dodavatele (odst. 1 písm. e)

Právo na bezplatnou volbu a změnu dodavatele nebo agregátora je přímou transpozicí čl. 12 směrnice 2019/944. Zákon nezakazuje sjednání výpovědní doby u smluv na dobu neurčitou (odst. 2 písm. l), ale výpovědní doba nesmí fakticky bránit změně dodavatele — právo na změnu je bezplatné, nikoliv bez výpovědní doby.

#### Právo na smlouvu s dynamickou cenou nebo pevnou cenou (odst. 1 písm. i)

Toto právo transponuje čl. 11 a 12 směrnice 2019/944. Zákazník má zákonné právo na uzavření smlouvy s **dynamickým určením ceny** (podmínka průběhového měření), nebo se smlouvou s **pevnou cenou** na dobu alespoň 1 roku. Povinnost nabízet obě varianty se vztahuje na obchodníky s min. 200 000 odběrnými místy (§ 30 odst. 3) — viz [06-hlava2-dil1-elektroenergetika-b.md](06-hlava2-dil1-elektroenergetika-b.md).

#### Právo provozu výrobny nebo úložiště v odběrném místě — zjednodušený oznamovací postup (odst. 5)

Odst. 5 zavádí pro zákazníka-prosumera (zákazník provozující výrobnu nebo úložiště) dvoustupňový systém přístupu:

1. **Standardní připojení** (výkon do 100 kW): smlouva o připojení, podmínky provozovatele distribuční soustavy.
2. **Zjednodušené oznamovací připojení** (výkon do 10,8 kW): zákazník pouze oznámí záměr elektronicky provozovateli distribuční soustavy; splní technické podmínky; pokud provozovatel distribuční soustavy do **30 dnů** neodmítne, nastává **fikce souhlasu** — smlouva o připojení se automaticky rozšíří o připojení výrobny nebo úložiště.

Prahová hodnota 10,8 kW odpovídá třífázovému připojení o maximálním jmenovitém proudu 16 A × 3 × 225 V = 10,8 kW — tedy standardní domácí fotovoltaická instalace.

#### Povinnosti zákazníka-prosumera (odst. 6)

Zákazník provozující výrobnu nebo úložiště přejímá povinnosti bezpečnosti, odbornosti, environmentální ochrany, podřízenosti dispečinku, kvality elektřiny a participace na nákladech připojení. Jde o kompromis mezi zjednodušeným přístupem (zjednodušené oznamovací připojení) a odpovědností za bezpečný provoz zařízení.

#### Sdílení elektřiny zákazníkem (odst. 7–8)

Zákazník je oprávněn sdílet elektřinu ze své výrobny nebo úložiště do dalších vlastních odběrných míst (s využitím soustavy) nebo do jiných odběrných míst zákazníků bez využití soustavy (za podmínky jedné pojistkové skříně). Zákazník smí výlkupy elektřiny ze své výrobny nebo úložiště realizovat pouze prostřednictvím obchodníka s elektřinou nebo na organizovaných trzích (odst. 9) — přímý prodej mimo obchodníky zákazníkem-prosumerem není přípustný.

#### Povinnosti vlastníka nemovitosti (odst. 10)

Odst. 10 ukládá vlastníkovi nemovitosti, do které je elektřina dodávána na základě smlouvy, pasivní povinnosti: umožnit dodávku, udržovat společnou instalaci, poskytovat technické údaje a umožnit přístup. Tato úprava reaguje na mnohočetné odběry v bytových domech a zajišťuje, aby povinnosti provozovatele distribuce a obchodníka nebyly zmařeny odmítnutím vlastníka nemovitosti.
