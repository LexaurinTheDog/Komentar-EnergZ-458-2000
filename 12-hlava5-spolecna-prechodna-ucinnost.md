# Část první (Hlava V) a závěrečné části — Společná, přechodná a závěrečná ustanovení; účinnost (§§ 96–99)

> **Téma kapitoly:** Hlava V uzavírá věcnou část energetického zákona souborem průřezových ustanovení, která procházejí horizontálně všemi odvětvovými hlavami. Jde o pět tematických okruhů: (i) **procesní pravidla pro řízení vedená ERÚ** — odchylky od správního řádu, zvláštní úprava sporných, schvalovacích a řídových řízení, lhůty, ochrana chráněných informací ve spisu (§ 96 a § 96a–§ 96c); (ii) **donucovací pokuty a odvod majetkového prospěchu** jako specifické vymáhací nástroje (§ 96d–§ 96e); (iii) **prokazatelná ztráta a přiměřený zisk** vyplacené v nesprávné výši (§ 97); (iv) **schvalovací řízení a řízení o stanovení řádu** jako zvláštní kolaborativní procedura pro provozní řády soustav (§ 97a–§ 97aa); (v) **věcná břemena k nemovitostem státních osob** (§ 97b). Na tuto průřezovou skupinu navazují **přechodná ustanovení** (§ 98) a **zmocňovací ustanovení** (§ 98a) s rozsáhlou tabulkou prováděcích vyhlášek. Zákon uzavírají **zrušovací ustanovení** (§ 99) a formálně samostatné části novelizující zákon o zřízení ministerstev (část druhá) a živnostenský zákon (část čtvrtá), zakončené **ustanovením o účinnosti** (§ 104 části šesté). Kapitola je formálně závěrečná, avšak věcně klíčová: zvláštní procesní pravidla ERÚ de facto konstituují autonomní správněprocesní nadstavbu nad správním řádem, zmocňovací § 98a tvoří základní architekturu prováděcí normotvorby v rozsahu přes 30 dílčích delegací na ministerstvo a ERÚ.
...
### § 96 — Společná ustanovení (procesní pravidla ERÚ)
...
>
> *(12) Pokud se pro stanovení náhrady za zřízení věcného břemene podle tohoto zákona zpracovává znalecký posudek, určí se náhrada ve výši ceny práva odpovídajícího věcnému břemenu zjištěné podle oceňovacího předpisu.*
>
...
#### Systematika § 96 — průřezové společné ustanovení

§ 96 je typickým „košovým" článkem, který soustřeďuje procesní a hmotněprávní pravidla s průřezovým dosahem. Po četných novelách (naposledy novelami reagujícími na směrnice vnitřního trhu s elektřinou a plynem v letech 2021–2024) § 96 obsahuje třináct odstavců, pokrývajících procesní specifika řízení ERÚ, kontinuitu smluvních závazků při licenčních omezeních, přechod povinností na právní nástupce, sektorový dozor bezpečnostních a obranných složek a zvláštní pravidla pro věcná břemena energetických zařízení.

#### Sporné řízení s podmínkou souhlasu odpůrce (odst. 1)

Odstavec 1 upravuje specifický typ sporného řízení dle § 17 odst. 7 písm. b) — ERÚ je oprávněn rozhodovat spor jen tehdy, pokud odpůrce s jeho pravomocí **výslovně souhlasí** ve lhůtě 15 dnů od oznámení o podání návrhu. Jde o zcela výjimečnou konstrukci podmíněné jurisdikce regulátora: navrhovatel může iniciovat řízení, avšak bez souhlasu odpůrce ERÚ návrh usnesením odloží. Smyslem je zachovat svobodu volby mezi správní a soudní cestou řešení sporů; ERÚ je příslušný jen tam, kde obě strany akceptují jeho pravomoc. Zahájení řízení je navázáno na den doručení souhlasu odpůrce, nikoli na podání návrhu — tím se liší od standardního správního řízení (§ 44 správního řádu).

#### Zvláštní lhůty pro vydání rozhodnutí ERÚ (odst. 2)

Odstavec 2 zavádí trojí kategorii odlišných lhůt pro vydání rozhodnutí ERÚ:

| Typ řízení | Základní lhůta | Lhůta ve zvláště složitých případech |
|---|---|---|
| Sporné správní řízení (§ 141 SŘ) a řízení schvalovací a o stanovení řádu (§ 97a) | 4 měsíce | 6 měsíců |
| Spor o připojení nebo přístup výrobny elektřiny k soustavě | 3 měsíce | 6 měsíců |
| Spor zahájený na návrh spotřebitele | 90 dnů | 120 dnů |

Odchylka od obecné lhůty 30 dnů dle § 71 správního řádu je výrazná, avšak odůvodněná: spory v energetice vyžadují znalecké posudky, hospodářské analýzy a koordinaci s operátorem trhu. Zvláštní zkrácená lhůta pro spotřebitelské spory (90/120 dnů) odráží požadavky práva EU (směrnice 2019/944) na rychlé řešení spotřebitelských sporů u regulátora.

Zákon zároveň výslovně vylučuje aplikaci ustanovení správního řádu o možném způsobu ukončení řízení o rozkladu — ERÚ tedy nemůže rozklad zamítnout jen proto, že by jiným způsobem mohl dosáhnout stejného výsledku jako odvolací orgán; musí vždy věcně přezkoumat a rozhodnout.

#### Konstitutivní rozhodnutí o úpravě vzájemných práv stran sporu (odst. 3)

Odstavec 3 přiznává ERÚ zvláštní pravomoc: ve sporech o uzavření nebo změnu smlouvy o připojení nebo přístupu k soustavě ERÚ přímo **upraví vzájemná práva a povinnosti stran** — tedy nejen autoritativně uloží povinnost uzavřít smlouvu, ale stanoví její obsah. Jde o konstitutivní správní akt, jehož výsledkem je vznik závazkového vztahu mezi soukromoprávními subjekty. Zákon přitom ukládá ERÚ dbát na to, aby nevznikla **značná nerovnováha** v právech a povinnostech stran, čímž přenáší do správního řízení princip analogický zásadě poctivosti a dobrých mravů z občanského zákoníku (§ 6 a § 547 OZ).

#### Ochrana chráněných informací ve spisu (odst. 4)

Odstavec 4 řeší napětí mezi zásadou přístupu k informacím a ochranou obchodního tajemství a jiných chráněných informací v regulatorních řízeních. Zákon zavádí systém **duplicitního spisu**: vedle plné verze listiny, obsahující chráněné informace, musí být ve spisu k dispozici i verze s odstraněnými chráněnými informacemi nebo dostatečně podrobný výpis. Povinnost takový anonymizovaný dokument zajistit dopadá na osobu, jejíž informace mají být chráněny — tedy zpravidla na dominantního hráče na trhu, od nějž ERÚ informace vyžaduje.

Zvláštní režim platí pro **řízení o vydání cenového výměru**: zde jsou chráněné informace uchovávány zcela mimo spis. Tím je dosaženo maximální ochrany při cenovém regulačním řízení — cenové podklady regulovaných subjektů zpravidla obsahují nejcitlivější obchodní informace.

#### Subsidiární aplikace občanského zákoníku (odst. 5)

Odstavec 5 je obecnou kolizní normou pro energetické smlouvy: zákon je lex specialis, na zákon navazuje (nebo jím upravený) smluvní typ (smlouva o připojení, smlouva o přístupu, smlouva o dodávce); na vše ostatní dopadá občanský zákoník podle nejbližšího smluvního typu. V praxi se nejčastěji uplatní ustanovení OZ o smlouvách příkazního, mandátního nebo smlouvě o dílo charakteru — ale vždy s přihlédnutím k povaze věci. Energetický zákon tak vědomě nevytváří uzavřený smluvní systém, ale odkazuje na obecnou soukromoprávní úpravu.

#### Kontinuita dodávkových smluv při povinnosti nad rámec licence (odst. 6)

Odstavec 6 chrání funkčnost uloženého plnění nad rámec licence: jestliže ERÚ nařídí držiteli licence pokračovat v dodávkách (§ 12 odst. 2–4), musí i dodavatelé paliva, energie a surovin pro tohoto držitele pokračovat v plnění svých smluv vůči tzv. dodavateli nad rámec licence. Jde o zákonem stanovenou povinnost třetí strany, jejímž účelem je zabránit kolapsu dodávkového řetězce: bez zajištění vstupů by povinnost nad rámec licence nebyla fakticky plnitelná. Podmínkou je, aby dodavatel nad rámec licence sám plnil své závazky od právní moci rozhodnutí ERÚ.

#### Přechod regulatorních povinností na právní nástupce (odst. 7)

Odstavec 7 stanoví universální sukcesorní pravidlo pro rozhodnutí ERÚ dle § 18a odst. 3, § 58l odst. 2 a § 12 odst. 2–4: povinnost z opatření k nápravě nebo z příkazu k plnění nad rámec licence přechází na právního nástupce. U povinností vázaných na energetické zařízení přechází povinnost nejen na právního nástupce (při přeměně), ale i na **nabyvatele zařízení** — čímž zákon zajišťuje, že prodej nebo vklad energetického zařízení nemůže být použit jako únikový mechanismus z regulatorních povinností. Solidarní odpovědnost více nástupců a nabyvatelů chrání veřejný zájem na splnění povinnosti.

#### Sektorový dozor bezpečnostních a obranných složek (odst. 8)

Odstavec 8 přebírá tradiční výjimku z civilní kontroly pro vojenské a bezpečnostní objekty: dozor v objektech obrany státu provádí MO, v objektech Ministerstva vnitra, Policie ČR, HZS ČR, zpravodajských služeb a jimi zřízených organizací MV, v objektech Ministerstva spravedlnosti MS. Tyto složky při výkonu dozoru postupují **podle § 18 energetického zákona** — tedy s plnou pravomocí ukládat pokuty dle hlavy třetí (EnZ) nebo hlavy páté (zákon o hospodaření energií) nebo hlavy desáté (zákon o podporovaných zdrojích). Smyslem je zachovat bezpečnostní vylučovací mechanismus: civilní orgán (ERÚ, Státní energetická inspekce) do vojenských a bezpečnostních objektů nevstupuje.

#### Věcná břemena energetických zařízení — zvláštní pravidla pořadí a přechodu (odst. 9–13)

Odstavce 9 až 13 tvoří kompaktní soubor věcněprávních pravidel pro věcná břemena energetických zařízení:

- **Odst. 9:** Historická věcná práva k cizím nemovitostem, která se nezapisovala do veřejného seznamu (zejména břemena zřízená zákonem před rokem 1994), jsou chráněna **prolomením intabulačního principu** — nezapsané věcné právo energetické infrastruktury má přednost, pokud vzniklo dříve než zapsané právo třetí osoby. Tím je chráněna rozsáhlá síťová infrastruktura, u níž historický zápis nebyl technicky ani organizačně možný.
- **Odst. 10:** Věcná břemena přechází automaticky na nového držitele licence provozujícího danou soustavu — tedy se soustavou (aktivy) a licencí přechází i celý právní aparát věcněprávních vztahů potřebných pro provoz.
- **Odst. 11:** Nabyvatel nemovitosti zatížené zákonným věcným břemenem přejímá odpovídající povinnosti — kupující pozemku pod energetickým zařízením musí strpět jeho provoz bez ohledu na to, zda věcné břemeno bylo v kupní smlouvě zmíněno.
...
<!-- LEGAL-REVISION:BEGIN id=51f127f5b1b41382ed79 generator=2026-07-17.4 source_sha256=57876e790ac9dc77563d9dcc03e109fca09df7493f9c4204cd3ff9184f09d947 -->
...
> (1) Energetický regulační úřad je příslušný k rozhodování sporů o právech či povinnostech vyplývajících z právního vztahu podle § 17 odst. 7 písm. b) tehdy, pokud současně s podáním návrhu na rozhodnutí ve sporu nebo ve lhůtě do 15 dnů ode dne doručení oznámení o podání návrhu rozhodovat ve sporu vyjádří odpůrce s pravomocí Energetického regulačního úřadu souhlas. Řízení je zahájeno dnem, v němž je souhlas odpůrce s pravomocí Energetického regulačního úřadu doručen tomuto úřadu. V opačném případě Energetický regulační úřad návrh usnesením odloží.
>
> (2) V řízeních vedených Energetickým regulačním úřadem se nepoužije ustanovení [[správního řádu|správního řádu]] o možném způsobu ukončení řízení o rozkladu. Při vedení sporných správních řízení ve smyslu [[§ 141|§ 141]] [[správního řádu|správního řádu]] a řízení schvalovacích a o stanovení řádu ve smyslu [[#§ 97a|§ 97a]] činí lhůta pro vydání rozhodnutí 4 měsíce, ve zvláště složitých případech 6 měsíců. Lhůta pro vydání rozhodnutí ve sporu o připojení nebo přístup výrobny elektřiny k přenosové soustavě, přepravní soustavě nebo distribuční soustavě činí 3 měsíce, ve zvláště složitých případech 6 měsíců. Lhůta pro vydání rozhodnutí ve sporu zahájeném na návrh spotřebitele činí 90 dnů, ve zvláště složitých případech 120 dnů.
>
> (3) Rozhoduje-li Energetický regulační úřad spor o uzavření nebo změnu smlouvy, jejímž předmětem je připojení nebo přístup k přenosové soustavě, přepravní soustavě nebo distribuční soustavě, těžebnímu plynovodu nebo zásobníku plynu nebo o uzavření jiné smlouvy podle § 17 odst. 7, rozhodne Energetický regulační úřad o úpravě vzájemných práv a povinností stran sporu. Při rozhodování dbá, aby nedošlo k založení nerovnováhy v právech a povinnostech stran sporu.
>
> (4) V řízeních vedených Energetickým regulačním úřadem jsou při nahlížení do spisu zákonem vyloučeny chráněné informace. Spis musí zahrnovat vedle listin obsahujících takové skutečnosti i listiny, ze kterých byly chráněné informace odstraněny, případně dostatečně podrobný výpis, který chráněné informace neobsahuje. Na žádost Energetického regulačního úřadu je osoba, které ochrana těchto skutečností svědčí, povinna vedle listin obsahujících takové skutečnosti předložit i listiny, ze kterých byly takové skutečnosti odstraněny, případně pořídit z takových listin dostatečně podrobný výtah, který takové skutečnosti neobsahuje. V řízení o vydání cenového výměru jsou chráněné informace uchovávány mimo spis.
>
> (5) Smlouvy upravené tímto zákonem se v ostatním řídí právní úpravou závazků a úpravou smluvních typů jim nejbližších podle [[občanského zákoníku|občanského zákoníku]], pokud z tohoto zákona nebo povahy věci nevyplývá něco jiného.
>
> (6) Dodavatel paliva, energie a surovin, které jsou nezbytné pro plnění povinnosti nad rámec licence, je povinen v rozsahu požadovaném dodavatelem nad rámec licence pokračovat v plnění smluv uzavřených s držitelem licence i vůči dodavateli nad rámec licence po dobu vykonatelnosti rozhodnutí o uložení povinnosti nad rámec licence, pokud dodavatel nad rámec licence plní závazky vzniklé z těchto smluv od právní moci rozhodnutí o uložení povinnosti nad rámec licence.
>
> (7) Povinnost vyplývající z opatření uloženého rozhodnutím Energetického regulačního úřadu podle § 18a odst. 3 nebo § 58l odst. 2 přechází na právního nástupce. Povinnost vyplývající z rozhodnutí Energetického regulačního úřadu podle § 12 odst. 2, 3 nebo 4 přechází podle povahy na právního nástupce nebo na nabyvatele energetického zařízení, k němuž je rozhodnutí Energetického regulačního úřadu vázáno. Je-li právních nástupců nebo nabyvatelů energetického zařízení více, odpovídají za splnění povinnosti společně a nerozdílně.
>
> (8) Dozor nad dodržováním tohoto zákona, zákona [[o hospodaření energií|o hospodaření energií]] a zákona [[o podporovaných zdrojích energie a o změně některých zákonů|o podporovaných zdrojích energie a o změně některých zákonů]] v objektech důležitých pro obranu státu provádí Ministerstvo obrany, v objektech sloužících k plnění úkolů Ministerstva vnitra, Policie České republiky, Policejní akademie České republiky, Hasičského záchranného sboru České republiky, Úřadu pro zahraniční styky a informace, Bezpečnostní informační služby a v objektech organizačních složek státu a příspěvkových organizací zřízených Ministerstvem vnitra provádí Ministerstvo vnitra, v objektech Ministerstva spravedlnosti provádí Ministerstvo spravedlnosti. Při výkonu dozoru postupuje Ministerstvo obrany, Ministerstvo vnitra a Ministerstvo spravedlnosti podle [[#§ 18|§ 18]] tohoto zákona a v případě uložení pokuty podle hlavy třetí tohoto zákona nebo podle hlavy páté zákona [[o hospodaření energií|o hospodaření energií]] nebo podle hlavy desáté zákona o podporovaných zdrojích energie.
>
> (9) Na oprávnění k cizím nemovitostem, pokud jde o energetická zařízení, jakož i omezení jejich užívání, které se nezapisovalo podle předchozích právních předpisů do veřejného seznamu, se nevztahuje zásada přednosti věcného práva k cizím nemovitostem zapsaného do veřejného seznamu před věcným právem, které není z veřejného seznamu zřejmé. V případě zápisu takového oprávnění k cizím nemovitostem do veřejného seznamu se při stanovení jeho pořadí vychází z okamžiku, kdy takové oprávnění k cizím nemovitostem vzniklo.
>
> (10) Oprávnění k cizím nemovitostem, jakož i omezení jejich užívání vzniklá podle předchozích právních úprav nebo z věcného břemene vzniklá podle tohoto zákona přechází na nového držitele licence provozujícího příslušnou soustavu, zařízení nebo jejich část, na které se daná oprávnění vztahují.
...
- Výslovné vnitřní odkazy v místním znění: § 17, § 141, § 97a, § 18a, § 58l, § 12, § 18
...
<!-- LEGAL-REVISION:END id=51f127f5b1b41382ed79 -->
...
#### Vyšetřovací a informační pravomoc ERÚ ve sporném řízení

§ 96a přiznává ERÚ ve sporném řízení **aktivní vyšetřovací pravomoc** nad rámec standardních oprávnění správního orgánu dle správního řádu. Zatímco v klasickém sporném správním řízení (§ 141 SŘ) jsou účastníci primárně povinni tvrdit a prokazovat svá tvrzení, § 96a jde dál: ERÚ může vyžadovat předložení veškerých důkazů na podporu tvrzení obou stran — tedy i důkazů, které účastník sám nepovažoval za relevantní nebo je záměrně nezmiňoval.

Povinnost účastníků zahrnuje dvě složky:

| Povinnost | Obsah |
|---|---|
| **Aktivní součinnost** (písm. a) | Poskytnout vysvětlení, předložit doklady, účastnit se jednání — na výzvu a ve stanovené lhůtě |
| **Pasivní zpřístupnění** (písm. b) | Umožnit ERÚ nahlédnout do obchodních záznamů vztahujících se ke sporu |
...
<!-- LEGAL-REVISION:BEGIN id=10a59bb2c799ffa402f2 generator=2026-07-17.4 source_sha256=57876e790ac9dc77563d9dcc03e109fca09df7493f9c4204cd3ff9184f09d947 -->
#### Revizní doplnění k § 96a
...
<!-- LEGAL-REVISION:END id=10a59bb2c799ffa402f2 -->
...
#### Lis pendens a ne bis in idem ve sporném řízení ERÚ

§ 96b řeší střet pravomoci ERÚ a soudní (nebo rozhodčí) pravomoci ve sporném řízení dle § 17 odst. 7 písm. e) (typicky spory o uzavření smlouvy o přístupu k soustavě, jejichž projednání ERÚ obligatorně příslušelo). Zákon volí dvě pravidla:
...
<!-- LEGAL-REVISION:BEGIN id=63a7927dec7795a13721 generator=2026-07-17.4 source_sha256=57876e790ac9dc77563d9dcc03e109fca09df7493f9c4204cd3ff9184f09d947 -->
#### Revizní doplnění k § 96b
...
<!-- LEGAL-REVISION:END id=63a7927dec7795a13721 -->

### § 96ba — Výjimky z požadavků na připojení výroben elektřiny

> **§ 96ba**
>
> *(1) Energetický regulační úřad rozhoduje za podmínek stanovených přímo použitelným předpisem Evropské unie upravujícím kodex sítě pro požadavky na připojení výroben elektřiny k elektrizační soustavě (dále jen „Nařízení o kodexu sítě pro připojení výroben elektřiny") o žádosti výrobce elektřiny, provozovatele přenosové soustavy nebo provozovatele distribuční soustavy o udělení výjimky z požadavků na připojení výroben elektřiny stanovených Nařízením o kodexu sítě pro připojení výroben elektřiny.*
>
...
#### Implementace nařízení EU o kodexu sítě pro připojení výroben elektřiny

§ 96ba byl vložen do EnZ novelou implementující unijní právo — nařízení EU č. 2016/631 (kodex sítě pro požadavky na připojení výroben elektřiny) je přímo použitelné, avšak umožňuje členským státům resp. jejich regulačním orgánům udělovat výjimky z jeho technických požadavků, jsou-li pro výjimku relevantní technické nebo ekonomické důvody. ERÚ je v ČR příslušným orgánem pro tato řízení.

Zákon zavádí dva paralelní mechanismy: (i) **individuální výjimka** na žádost výrobce, provozovatele PPS nebo DS — rozhodnutí v řízeních dle odst. 1; (ii) **plošná výjimka** opatřením obecné povahy dle odst. 2 — ta může stanovit alternativní požadavky a musí být podložena analýzou nákladů a přínosů (art. 39 nařízení). Kolidují-li obě řízení, individuální se zastaví.
...
<!-- LEGAL-REVISION:BEGIN id=7f110835c45306d42844 generator=2026-07-17.4 source_sha256=57876e790ac9dc77563d9dcc03e109fca09df7493f9c4204cd3ff9184f09d947 -->
#### Revizní doplnění k § 96ba — Výjimky z požadavků na připojení výroben elektřiny k elektrizační soustavě
...
<!-- LEGAL-REVISION:END id=7f110835c45306d42844 -->
...
#### Retrofitting stávajících výroben

§ 96bb je protipólem k § 96ba: zatímco § 96ba umožňuje výjimky z nových požadavků pro nové výrobny, § 96bb umožňuje **dodatečné uložení požadavků** kodexu sítě i na výrobny, které byly připojeny před jeho účinností (tzv. stávající výrobny dle čl. 4 odst. 2 nařízení). Tato pravomoc je opět vykonávána opatřením obecné povahy s povinným zveřejněním analýzy nákladů a přínosů.
...
<!-- LEGAL-REVISION:BEGIN id=93d6762e02a9c860fdfb generator=2026-07-17.4 source_sha256=57876e790ac9dc77563d9dcc03e109fca09df7493f9c4204cd3ff9184f09d947 -->
#### Revizní doplnění k § 96bb — Rozšíření požadavků na připojení výroben elektřiny podle Nařízení o kodexu sítě pro připojení výroben elektřiny
...
<!-- LEGAL-REVISION:END id=93d6762e02a9c860fdfb -->

### § 96c — Přezkum souladu rozhodnutí ERÚ s předpisem EU

> **§ 96c**
>
> *(1) Rozhodne-li Komise o tom, že rozhodnutí vydané Energetickým regulačním úřadem je v rozporu s přímo použitelným předpisem Evropské unie vydaným na základě nebo k provedení předpisů Evropské unie v oblasti vnitřního trhu s elektřinou nebo s plynem, provede Energetický regulační úřad přezkumné řízení a vydá rozhodnutí do 2 měsíců ode dne, kdy Komise takové rozhodnutí vydala. Energetický regulační úřad o vydání rozhodnutí informuje bez zbytečného odkladu Komisi.*
>
...
#### Mechanismus přezkumu na podnět Komise EU nebo ACER

§ 96c implementuje mechanismus dohledu Komise EU a Agentury pro spolupráci energetických regulačních orgánů (ACER) nad národními regulačními rozhodnutími. Nařízení EU 2019/943 (vnitřní trh s elektřinou) a nařízení EU 2024/1789 (vnitřní trh s plynem) svěřují Komisi a ACER pravomoc vydávat rozhodnutí (a v určitých případech doporučení) k nápravě kolizí národních regulatorních aktů s unijním právem.
...
<!-- LEGAL-REVISION:BEGIN id=899572799b0eae5de1f8 generator=2026-07-17.4 source_sha256=57876e790ac9dc77563d9dcc03e109fca09df7493f9c4204cd3ff9184f09d947 -->
#### Revizní doplnění k § 96c — Přezkum souladu rozhodnutí Energetického regulačního úřadu s předpisem Evropské unie
...
>
> (2) Pro přezkoumání souladu rozhodnutí vydaného Energetickým regulačním úřadem s předpisem Evropské unie platí obdobně ustanovení [[správního řádu|správního řádu]] o přezkumném řízení s tím, že Energetický regulační úřad není vázán lhůtami pro vydání usnesení o zahájení přezkumného řízení a pro vydání rozhodnutí ve věci v přezkumném řízení.
>
> (3) Odstavce 1 a [[#§ 2|2]] se použijí obdobně v případech, kdy Komise rozhodla o tom, že opatření obecné povahy vydané Energetickým regulačním úřadem je v rozporu s předpisem Evropské unie nebo kdy Komise nebo Agentura vydala v případech stanovených předpisem Evropské unie doporučení ke zrušení nebo změně rozhodnutí nebo opatření obecné povahy vydané Energetickým regulačním úřadem.
...
<!-- LEGAL-REVISION:END id=899572799b0eae5de1f8 -->

### § 96d — Donucovací pokuty
...
#### Donucovací pokuta jako nástroj správní exekuce sui generis

Donucovací pokuta (astreinte) je nástroj **nepřímého vynucení splnění nepeněžité povinnosti**: na rozdíl od pokut za přestupek, jejichž funkcí je represivní sankce za minulé protiprávní jednání, donucovací pokuta slouží výhradně k tlaku na splnění konkrétní povinnosti — lze ji ukládat opakovaně až do splnění. Jde o specifický institut správní exekuce, odlišný od exekuce podle správního řádu (§§ 103–129 SŘ), a správní řád (konkrétně § 105 odst. 2 o penězitých povinnostech ve výkonu rozhodnutí) se použije jen subsidiárně v rozsahu, ve kterém EnZ nestanoví jinak (odst. 3).

#### Katalog vymahatelných povinností

Zákon taxativně vymezuje povinnosti, jejichž splnění ERÚ (odst. 1) nebo ministerstvo (odst. 2) může vymáhat donucovací pokutou:

| Pododstavec | Vymáhaná povinnost |
|---|---|
| odst. 1 písm. a) | Povinnost držitele licence dle § 10 odst. 4 (informační povinnosti při zániku licence) |
| odst. 1 písm. b) | Poskytnutí zařízení a umožnění výkonu povinnosti nad rámec licence (§ 12 odst. 2–4) |
| odst. 1 písm. c) | Plnění dodávek tepla, distribuce el. nebo plynu nad rámec licence (§ 12 odst. 2–4) |
| odst. 1 písm. d) | Opatření k nápravě uložená ERÚ dle § 18 odst. 3 |
| odst. 1 písm. e) | Opatření ERÚ dle § 18a odst. 3 nebo § 58l odst. 2 (unbundling, IT systémy PS) |
| odst. 1 písm. f) | Povinnosti z rozhodnutí ERÚ/Komise/ACER dle nařízení EU o vnitřním trhu |
| odst. 1 písm. g) | Uzavření smlouvy dle pravomocného rozhodnutí ERÚ (§ 17 odst. 7 písm. a) |
| odst. 2 | Přístup do zásobníku plynu; opatření MPS/MZS dle § 73 a § 73d |

#### Výše pokut a odstupňování

Zákon rozlišuje maxima donucovacích pokut podle subjektu:

| Subjekt | Standardní maximum | Výjimka |
|---|---|---|
| Fyzická osoba | 100 000 Kč | Povinnost dle odst. 1 písm. c): 1 000 000 Kč |
| Právnická nebo podnikající fyzická osoba | 5 000 000 Kč | Povinnost dle odst. 1 písm. b): 10 000 000 Kč |
| Držitel licence | 10 000 000 Kč | — |
...
<!-- LEGAL-REVISION:BEGIN id=6bb704a696832a82c83c generator=2026-07-17.4 source_sha256=57876e790ac9dc77563d9dcc03e109fca09df7493f9c4204cd3ff9184f09d947 -->
#### Revizní doplnění k § 96d — Donucovací pokuty
...
> - a) povinnosti držitele licence podle § 10 odst. 4,
>
> - b) povinnosti poskytnout energetické zařízení držiteli licence pro výkon povinnosti nad rámec licence a umožnit výkon povinnosti nad rámec licence podle rozhodnutí Energetického regulačního úřadu podle § 12 odst. 2, [[#§ 3|3]] nebo [[#§ 4|4]],
>
> - c) povinnosti poskytovat dodávky tepelné energie nad rámec licence, zajišťovat distribuci elektřiny nebo distribuci plynu nad rámec licence nebo výroby elektřiny nad rámec licence podle rozhodnutí Energetického regulačního úřadu podle § 12 odst. 2, [[#§ 3|3]] nebo [[#§ 4|4]],
>
> - d) povinnosti vyplývající z opatření k nápravě nebo podmínek stanovených k zajištění splnění opatření k nápravě uložených rozhodnutím Energetického regulačního úřadu podle § 18 odst. 3,
>
> - e) povinnosti vyplývající z opatření uloženého rozhodnutím Energetického regulačního úřadu podle § 18a odst. 3 nebo § 58l odst. 2,
...
> (2) Ministerstvo vymáhá ukládáním donucovacích pokut splnění povinnosti provozovatele zásobníku plynu umožnit přístup účastníkům trhu s plynem do zásobníku plynu k nevyužité skladovací kapacitě za cenu nebo jiných podmínek stanovených rozhodnutím ministerstva podle § 60d odst. 2. Ministerstvo dále vymáhá ukládáním donucovacích pokut splnění povinností nebo zákazů vyplývajících z opatření uloženého rozhodnutím ministerstva podle § 73 odst. 9 nebo § 73d odst. 6.
>
> (3) Ustanovení [[§ 105 odst. 2|§ 105 odst. 2]] [[správního řádu|správního řádu]] není dotčeno.
>
> (4) Donucovací pokutu lze ukládat opakovaně. Výše jednotlivé donucovací pokuty ukládané
>
> - a) fyzické osobě nesmí přesahovat 100 000 Kč, s výjimkou porušení povinnosti podle odstavce 1 písm. c), kdy nesmí přesahovat 1 000 000 Kč,
...
- Výslovné vnitřní odkazy v místním znění: § 10, § 12, § 3, § 4, § 18, § 18a, § 58l, § 17, § 60d, § 73, § 73d, § 105
...
<!-- LEGAL-REVISION:END id=6bb704a696832a82c83c -->
...
#### Historický kontext — krizový nástroj energetické krize 2022

§ 96e byl vložen do energetického zákona v rámci krizové legislativy reagující na bezprecedentní vzestup cen elektřiny a plynu v letech 2021–2022. Navazuje na nařízení Rady (EU) 2022/1854 o krizové intervenci k řešení vysokých cen energie — unijní předpis sám ukládal povinnost odvodu tzv. mimořádného příjmu výrobcům elektřiny, avšak ČR zvolila i doplňkový mechanismus cílený na **spotřebitelskou stranu trhu**: účastníky, kteří z vládního zastropování cen získali prospěch přesahující zákonem přípustnou míru.

#### Systém odvodu — dva druhy majetkového prospěchu

§ 96e rozlišuje dva odlišné situace:

| Druh prospěchu | Definice | Rozhodující orgán | Příjemce odvodu |
|---|---|---|---|
| **Nadměrný majetkový prospěch** | Prospěch z vládní ceny přesahující vládou stanovené maximum | Ministerstvo | Státní rozpočet |
| **Neoprávněný majetkový prospěch** | Prospěch z vládní ceny při nesplnění věcných podmínek pro její uplatnění | ERÚ | Státní rozpočet |

**Nadměrný prospěch** vzniká, kdyžúčastník trhu sice splnil podmínky pro aplikaci vládní ceny, avšak výsledný prospěch (rozdíl mezi smluvní a vládní cenou) přesáhl vládou stanovenou přípustnou horní hranici. Typickým příkladem jsou průmysloví odběratelé s vysokou spotřebou, u nichž rozdíl mezi smluvní a zastropovanou cenou byl enormní.

**Neoprávněný prospěch** vzniká, když vládní cena byla uplatněna, ačkoli účastník trhu nesplnil podmínky (typ odběratele, výše spotřeby, charakter objektu). Rozhoduje ERÚ jako správní orgán příslušný pro cenovou regulaci.

#### Mechanismus odvodu a penalizace (odst. 3–6)

Povinnost odvodu nadměrného prospěchu vzniká ex lege uplynutím cenového období; účastník trhu musí zpracovat zprávu o posouzení vzniku prospěchu a odvod provést sám. Zákon stanovuje splatnost na konec šestého měsíce od vzniku povinnosti nebo jiné lhůtě dle nařízení vlády. V případě prodlení vzniká **penále 0,1 % denně** — sazba odpovídající úroku z prodlení dle daňového řádu, nikoli civilnímu úroku z prodlení (§ 1970 OZ).

Správu placení odvodu vykonává **celní úřad** (odst. 8) — tato volba reflektuje zkušenosti celní správy s vymáháním odvodu solidarity (energetická daň z nadměrných příjmů výrobců) a slouží ke koordinaci s celní správou jako správcem daní z energií.
...
<!-- LEGAL-REVISION:BEGIN id=d54539bf9a1cd0daefa4 generator=2026-07-17.4 source_sha256=57876e790ac9dc77563d9dcc03e109fca09df7493f9c4204cd3ff9184f09d947 -->
#### Revizní doplnění k § 96e — Odvod neoprávněného majetkového prospěchu nebo nadměrného majetkového prospěchu
...
<!-- LEGAL-REVISION:END id=d54539bf9a1cd0daefa4 -->
...
#### Prokazatelná ztráta a přiměřený zisk — charakter platby

Prokazatelná ztráta a přiměřený zisk jsou kompenzační platby z prostředků operátora trhu (OTE, a.s.) určené pro dodavatele plnící povinnosti nad rámec licence (zásobování chráněných zákazníků). Platby jsou zákonem a prováděcí vyhláškou striktně regulovány — mají kompenzovat skutečnou ztrátu a přiměřený (tj. regulací schválený) zisk, nikoli neoprávněnou úroveň marže.

#### Mechanismus vymáhání nesprávné platby

§ 97 nastavuje dvoustupňový mechanismus nápravy nesprávné platby:

1. **Dobrovolné vrácení** — primárně má účastník vrátit nebo nechat započíst platbu operátorovi trhu (odst. 1); OTE může i jednostranně započítat.
2. **Rozhodnutí ERÚ z moci úřední** — nedojde-li k vrácení, ERÚ rozhodne o výši nesprávné platby a uloží povinnost odvodu do státního rozpočtu (odst. 2–3).

Zákon zakotvuje **sankcí za nepravdivé podklady** penále 0,1 % denně (odst. 4) — jde o odpovídající kvalifikovaný případ, kde k nesprávné platbě došlo v důsledku klamavých nebo neúplných žádostí. Tato sankce má odstrašující charakter a motivuje k pečlivosti při dokládání výše ztráty.
...
<!-- LEGAL-REVISION:BEGIN id=f79a88b7ad6407eb9a60 generator=2026-07-17.4 source_sha256=57876e790ac9dc77563d9dcc03e109fca09df7493f9c4204cd3ff9184f09d947 -->
#### Revizní doplnění k § 97 — Prokazatelná ztráta a přiměřený zisk poskytnuté v nesprávné výši
...
<!-- LEGAL-REVISION:END id=f79a88b7ad6407eb9a60 -->
...
#### Provozní řády jako instrumenty regulace sítí

Pravidla provozování přenosové soustavy, Řád provozovatele distribuční soustavy, Řád provozovatele zásobníku plynu a obchodní podmínky operátora trhu jsou **klíčovými sekundárními normativními akty energetického sektoru**. Nejsou podzákonnými předpisy (nejsou vydávány obecně závaznou formou vyhlášky ani nařízení), avšak jejich schválení ERÚ je podmínkou jejich platnosti a závaznosti. Po schválení ERÚ se stávají závaznými pro všechny účastníky trhu ve věcech, které upravují. Jsou to rozsáhlé dokumenty (stovky stran), podrobně upravující technické, obchodní a procesní podmínky přístupu k sítím, měření, zúčtování a dalším procesům.

#### Dvě větve řízení — na žádost a z moci úřední

§ 97a rozlišuje:
- **Řízení na žádost** (schvalovací) — standardní případ: držitel licence předloží ERÚ návrh řádu nebo jeho změny; ERÚ přezkoumá soulad s právem a kritériem rovnováhy a vydá rozhodnutí.
- **Řízení o stanovení řádu z moci úřední** — subsidiárně: buď jako reakce na nečinnost držitele licence (odst. 4), nebo jako reakce na zamítnutí návrhu (odst. 9). V takovém případě ERÚ aktivně vytváří regulatorní obsah sám — jde o mimořádné opatření s výrazným intenzivním regulatorním dopadem.

#### Participativní prvek — připomínky dotčených osob

Odst. 6 a 7 zavádějí povinné veřejné konzultační kolo: ERÚ zveřejní návrh řádu po dobu alespoň 10 pracovních dnů a každá dotčená osoba může uplatnit připomínky. Není to správní řízení ve smyslu SŘ — § 97a odst. 8 to výslovně vylučuje. Jde spíše o regulatorní konzultaci analogickou konzultacím dle unijního práva. Lhůta pro vydání rozhodnutí po dobu konzultačního kola neběží.
...
<!-- LEGAL-REVISION:BEGIN id=d47c4ab252e01c390c65 generator=2026-07-17.4 source_sha256=57876e790ac9dc77563d9dcc03e109fca09df7493f9c4204cd3ff9184f09d947 -->
#### Revizní doplnění k § 97a — Schvalovací řízení a řízení o stanovení řádu
...
> (7) Každý, jehož oprávněné zájmy mohou být schválením nebo stanovením řádu přímo dotčeny, může u Energetického regulačního úřadu uplatnit připomínky s jejich odůvodněním. Připomínkami, které se návrhu řádu netýkají, připomínkami, které uplatní osoba, jejíž oprávněné zájmy nemohou být schválením řádu přímo dotčeny, nebo připomínkami bez odůvodnění nebo uplatněnými po lhůtě se Energetický regulační úřad nezabývá. Výsledky vypořádání připomínek zveřejní Energetický regulační úřad před vydáním rozhodnutí na jeho internetových stránkách. Energetický regulační úřad může návrh řádu upravit s přihlédnutím k vyhodnocení připomínek. Pokud by takovou úpravou došlo k podstatné změně návrhu řádu, může Energetický regulační úřad rozhodnout o opakovaném zveřejnění návrhu řádu podle odstavce 6.
>
> (8) Na postup Energetického regulačního úřadu podle odstavce 6 a uplatňování připomínek a jejich vypořádání podle odstavce 7 se nevztahují obecné předpisy o správním řízení. Po dobu zveřejnění návrhu řádu na jeho internetových stránkách neběží lhůta pro vydání rozhodnutí. V řízení o schválení návrhu řádu se [[§ 45 odst. 4|§ 45 odst. 4]] [[správního řádu|správního řádu]] nepoužije.
>
> (9) Energetický regulační úřad návrh řádu, popřípadě návrh řádu upravený podle odstavce 7 schválí, není-li v rozporu s právním předpisem a pokud schválením návrhu řádu nedojde k založení značné nerovnováhy v právech a povinnostech účastníků trhu, jinak návrh řádu zamítne. V případě, kdy návrh řádu nebyl zcela nebo zčásti schválen, může Energetický regulační úřad stanovit řád nebo jeho část v řízení zahájeném z moci úřední.
>
> (10) V řízení o stanovení řádu postupuje Energetický regulační úřad tak, aby stanovením řádu nedošlo k založení značné nerovnováhy v právech a povinnostech účastníků trhu. Stanovený řád je držitel licence povinen bez zbytečného odkladu zveřejnit.
...
- Výslovné vnitřní odkazy v místním znění: § 25, § 59, § 17e, § 45
...
<!-- LEGAL-REVISION:END id=d47c4ab252e01c390c65 -->
...
#### Standardizovaná konzultační procedura u držitele licence

§ 97aa doplňuje § 97a a standardizuje proces **povinné konzultace návrhu řádu s dotčenými osobami** prováděné samotným držitelem licence (nikoli ERÚ). Zákon stanovuje tři fáze:

1. **Zveřejnění** — povinně na stránkách licence; ERÚ přebírá oznámení na svůj web (síňová transparentnost).
2. **Sběr připomínek** — nejméně 30denní lhůta pokud zákon nestanoví jinak; výsledky a způsob vypořádání se zveřejní.
3. **Zpráva o projednání** — podkladový dokument pro ERÚ při schvalovacím řízení.
...
<!-- LEGAL-REVISION:BEGIN id=fc4304679a0e262a3c78 generator=2026-07-17.4 source_sha256=57876e790ac9dc77563d9dcc03e109fca09df7493f9c4204cd3ff9184f09d947 -->
#### Revizní doplnění k § 97aa — Projednání návrhu řádu
...
<!-- LEGAL-REVISION:END id=fc4304679a0e262a3c78 -->

### § 97b — Věcná břemena k nemovitostem státu a státních osob
...
>
> *(3) Za zřízení věcného břemene uhradí oprávněný z věcného břemene vlastníkovi nemovitosti podle odstavce 1 jednorázovou náhradu až ve výši ceny zjištěné podle oceňovacího předpisu, pokud jej o to vlastník nemovitosti podle odstavce 1 požádá.*
>
...
#### Zákonné věcné břemeno ex lege — vznik ze zákona, nikoli z vůle stran

§ 97b zavádí specifický mechanismus vzniku věcného břemene: oprávnění v rozsahu nezbytném pro zřízení a provoz soustavy nebo výrobny OZE **vzniká přímo ze zákona, a to právní mocí rozhodnutí o povolení záměru**. K jeho vzniku tedy není potřeba smlouva o zřízení věcného břemene ani vklad do katastru — tyto kroky jsou potřebné jen pro jeho publicitu.

Okruh povinných subjektů (vlastníků zátěžových nemovitostí) je výslovně omezen na veřejné subjekty: stát, státní příspěvkové organizace, státní fondy, státní organizace a státní podniky. Věcné břemeno na soukromých pozemcích se i nadále zřizuje dohodou nebo vyvlastnitelným způsobem dle zákona o vyvlastnění (zákon č. 184/2006 Sb.).

#### Katastrální publicita — upozornění a vklad

Zákon zavádí dvoustupňový katastrální postup: (i) **zápisem upozornění** ihned po právní moci povolení záměru (varování třetím osobám o existenci budoucího věcného břemene); (ii) **vkladem věcného břemene** po kolaudaci stavby nebo jejím dokončení. Souběžně s vkladem věcného břemene musí být podán návrh na výmaz upozornění — tím se katastr udržuje v konzistentním stavu.

#### Náhrada za věcné břemeno a prekluzivní lhůta

Vlastník státní nemovitosti má právo na náhradu za věcné břemeno ve výši dle oceňovacího předpisu, avšak pouze na **žádost podanou do 3 let od vkladu do katastru** — po uplynutí této lhůty nárok zaniká. Tato prekluzivní lhůta vyvažuje zákonné zřízení břemene bez souhlasu vlastníka; stát jako vlastník nemovitosti musí aktivně uplatnit nárok.
...
<!-- LEGAL-REVISION:BEGIN id=05deb5d5d2c556488e65 generator=2026-07-17.4 source_sha256=57876e790ac9dc77563d9dcc03e109fca09df7493f9c4204cd3ff9184f09d947 -->
#### Revizní doplnění k § 97b — Věcná břemena k nemovitostem ve vlastnictví státu, státní příspěvkové organizace, státního fondu a státního podniku
...
<!-- LEGAL-REVISION:END id=05deb5d5d2c556488e65 -->
...
> **Anomálie — chybějící odstavce:** Text § 98 ve znění konsolidace k 1. 1. 2026 neobsahuje odstavce 6, 7 a 8 (číslování přeskakuje z odst. 5 na odst. 9). Tato mezera je výsledkem zrušení původních odstavců 6, 7 a 8 pozdějšími novelami; zákon jejich obsah nahradil jinými ustanoveními nebo je nevyžadoval. Komentář tedy věrně reflektuje toto číslování.

#### Přechod licenčního oprávnění (odst. 1)

Odst. 1 stanovil jednoletou přechodnou lhůtu pro podnikání v energetice pod starými předpisy: provozovatelé energetiky dle zákona č. 222/1994 Sb. museli do jednoho roku od 1. 1. 2001 podat žádost o licenci. Bez žádosti do roka oprávnění zaniklo automaticky. Toto ustanovení bylo plně konzumováno k 1. 1. 2002; zachovává si historický výkladový význam pro posuzování přerušení podnikání z doby přechodného období.

#### Kontinuita ochranných a bezpečnostních pásem (odst. 2–3)

Zásadní kontinuita: ochranná pásma v elektroenergetice a teplárenství a bezpečnostní pásma plynových zařízení zřízená dle zákona č. 222/1994 Sb. (a jeho prováděcích předpisů) zůstala beze změny. Výjimky z ochrany udělené před 1. 1. 2001 také zůstaly zachovány. Tím zákon zabraňuje vzniku právní nejistoty v rozsáhlých oblastech, kde energetická infrastruktura existuje desítky let a dokumentace k pásmům je vedena dle starých předpisů.

#### Kontinuita věcněprávních oprávnění k cizím nemovitostem (odst. 4)

Věcná břemena a omezení vlastnického práva k cizím nemovitostem vzniklá před 1. 1. 2001 zůstávají plně v platnosti — zákon nekonvaliduje ani neruší dříve existující věcná práva. Toto ustanovení je základem pro výklad § 96 odst. 9: historická nepopsaná věcná práva jsou nejenom zachována, ale požívají zvláštní ochrany v hierarchii věcných práv.

#### Živnostenský přechod pro obchodníky s LPG (odst. 5)

Souběžně s energetickým zákonem byl novelizován živnostenský zákon (viz část čtvrtá EnZ, § 102 níže): nákup, prodej a skladování zkapalněných uhlovodíkových plynů v tlakových nádobách byl přeřazen do vázaných živností. Osoby provozující tuto činnost před 1. 1. 2001 musely do jednoho roku zažádat o živnostenské oprávnění na tuto vázanou živnost.
...
<!-- LEGAL-REVISION:BEGIN id=3385ef410ac5f25a1582 generator=2026-07-17.4 source_sha256=57876e790ac9dc77563d9dcc03e109fca09df7493f9c4204cd3ff9184f09d947 -->
#### Revizní doplnění k § 98 — Přechodná ustanovení
...
> (10) O autorizaci na výstavbu musí požádat každá fyzická či právnická osoba, která podá žádost na vydání rozhodnutí o povolení záměru na novou výstavbu po dni nabytí účinnosti tohoto zákona.
>
> (11) Inspekce podle [[zákona č. 222/1994 Sb., o podmínkách podnikání a o výkonu státní správy v energetických odvětvích a o Státní energetické inspekci|zákona č. 222/1994 Sb., o podmínkách podnikání a o výkonu státní správy v energetických odvětvích a o Státní energetické inspekci]], ve znění [[zákona č. 83/1998 Sb|zákona č. 83/1998 Sb.]], je Státní energetickou inspekcí podle tohoto zákona.
>
> (12) Řízení o uložení pokuty zahájená před nabytím účinnosti tohoto zákona se dokončí podle dosavadních právních předpisů.
...
- zákon č. 222/1994 Sb. (výslovně uvedeno v místním znění)
...
<!-- LEGAL-REVISION:END id=3385ef410ac5f25a1582 -->
...
§ 98a soustřeďuje veškerá zákonná zmocnění k vydávání prováděcích vyhlášek ve dvou odstavcích: odst. 1 zmocňuje **Ministerstvo průmyslu a obchodu**, odst. 2 zmocňuje **Energetický regulační úřad**. Toto rozlišení respektuje kompetenční dělbu mezi silovou správou (ministerstvo — bezpečnost, bilance, autorizace, stav nouze, tepelná energie) a regulací (ERÚ — pravidla trhů, kvalita dodávek, připojování, regulační výkazy, ceny).

Rozsah zmocnění je mimořádně široký — § 98a je jedním z nejrozsáhlejších zmocňovacích ustanovení v českém správním právu vůbec.

#### Přehled zmocnění ministerstva (§ 98a odst. 1)

| Písm. | Předmět prováděcí vyhlášky |
|---|---|
| a) | Měřicí zařízení — druhy, typy, umístění, instalace, požadavky na kybernetickou bezpečnost, způsob náhrady škody při neoprávněném odběru, hodnoty fyzikálních a chemických parametrů kvality plynu |
| b) | Dispečerské řízení — způsoby, periodické zkoušky zařízení, rozsah a postup při dispečerském řízení, pravidla spolupráce dispečinků, výcvikový plán, termíny předávání dat pro přípravu a vyhodnocení provozu |
| c) | Bilance plynárenské soustavy — způsoby tvorby bilancí, sledování kapacit, termíny a rozsah předávání dat |
| d) | Autorizace vybraných plynových zařízení — náležitosti žádostí a podmínky posuzování |
| e) | Stav nouze — opatření při předcházení, stavu a odstraňování; vyhlášení, regulační, vypínací a frekvenční plány; bezpečnostní standard dodávky plynu; havarijní plány; chránění zákazníci; mezinárodní pomoc; minimální množství uskladněného plynu |
| f) | Technická pravidla v plynárenství — způsob a postup registrace u HK ČR |
| g) | Tepelná energie — termíny a rozsah předávání údajů z měřidel; způsob dělení nákladů při společném měření |
| h) | Autorizace na výstavbu výrobny elektřiny — vzory žádostí a postup posuzování |
| i) | Zbytkový energetický mix — pravidla sestavení |
| j) | Bezpečná instalace výroben OZE do 100 kW |
| k) | Vzor žádosti o souhlas s nabytím vlivu nad energeticky strategickým celkem |

#### Přehled zmocnění ERÚ (§ 98a odst. 2)

| Písm. | Předmět prováděcí vyhlášky |
|---|---|
| a) | Prokazování finančních a technických předpokladů pro licence; způsoby určení vymezeného území; náležitosti prohlášení odpovědného zástupce; vzory žádostí |
| b) | Obsahové náležitosti Pravidel provozování přenosové soustavy, Řádu provozovatele DS, Řádu PS, zásobníku, OTE, datového centra a plánu rozvoje regionální DS |
| c) | Kvalita dodávek a služeb — požadovaná úroveň, výše náhrad, postupy a lhůty uplatnění, zveřejňování |
| d) | Fond prokazatelné ztráty — výpočet příspěvků, čerpání, výpočet prokazatelné ztráty a dokladování |
| e) | Regulační výkazy — náležitosti, členění, vzory, odpisové sazby, pravidla sestavování, termíny |
| f) | Způsob regulace cen v energetice — postupy, termíny, limitní cena pro věcné usměrňování cen v teplárenství |
| g) | Připojování zařízení — v elektroenergetice: podmínky připojení výroben, DS a odběrných zařízení, paušální částky, rezervovaný příkon; v plynárenství: podmínky připojení výroben plynu, DS, zásobníků a odběrných míst, podíl nákladů |
| h) | Pravidla trhu s elektřinou (21 bodů) — přístup k PS a DS, termíny smluv, odpovědnost za odchylku, vyhodnocování odchylek, regulační energie, krátkodobý trh, typové diagramy, změna dodavatele, přerušení a obnovení dodávky, dodavatel poslední instance, ceny soustav, podmínky trhu pro nové technologie (flexibility, sdílení, ukládání), zranitelní zákazníci, dynamické ceny |
| i) | Pravidla trhu s plynem (19 bodů) — přístup k PS, DS, zásobníku, termíny smluv, odpovědnost za odchylku, vyrovnávací plyn, nominace, prodej neoprávněně uskladněného plynu, krátkodobé trhy, typové diagramy, změna dodavatele, přerušení dodávky, dodavatel poslední instance, ceny, přeshraniční zásobník, aukce kapacit, dynamické ceny |
| j) | Náležitosti vyúčtování dodávek el., plynu, tepla a flexibility — rozsah, náležitosti, termíny |
| k) | Uchovávaní údajů o plnění smluv na dodávky |
| l) | Nezávislý provozovatel PS — žádosti o schválení jmenování a odvolání členů statutárního orgánu, dozorčí rady; žádosti o auditora programu; prokazování odborné způsobilosti auditora |
| m) | Výkazy pro zprávy o provozu soustav — termíny, rozsah, pravidla sestavování |
| n) | Zprávy o kvalitě a údržbě zařízení — termíny, rozsah, pravidla |
| o) | Formulář žádosti o oprávnění zprostředkovatele |
| p) | Podmínky pro zřizování a provozování zařízení na úpravu složení plynu |
| q) | Monitorování soutěže na maloobchodním trhu s el. a plynem — informace, termíny, způsob předkládání |
...
<!-- LEGAL-REVISION:BEGIN id=4872e9c135fae6d996d2 generator=2026-07-17.4 source_sha256=57876e790ac9dc77563d9dcc03e109fca09df7493f9c4204cd3ff9184f09d947 -->
#### Revizní doplnění k § 98a — Zmocňovací ustanovení
...
> - f) způsob a postup registrace technických pravidel v plynárenství u Hospodářské komory České republiky, včetně postupu jejich tvorby a způsobu jejich projednávání a schvalování,
>
> - g) rozsah a termíny předávání údajů o dodávce tepelné energie dodavateli tepelné energie ze stanovených měřidel podle zákona [[o metrologii|o metrologii]] nebo údajů ze zařízení pro rozdělování nákladů na vytápění a dalších údajů potřebných pro rozdělování nákladů na vytápění a dodávku teplé vody a způsob dělení nákladů za dodávku tepelné energie při společném měření odebíraného množství tepelné energie pro více odběrných míst nebo v případě, že z odběrného místa jsou zásobovány tepelnou energií objekty nebo části objektů různých vlastníků, kteří uzavírají smlouvu o dodávce tepelné energie, a kdy nedojde k dohodě o způsobu rozdělení nákladů,
>
> - h) vzory žádostí o udělení autorizace na výstavbu výrobny elektřiny a postup ministerstva při jejich posuzování,
>
> - i) pravidla pro sestavení zbytkového energetického mixu,
...
- Výslovné vnitřní odkazy v místním znění: § 26, § 57
...
<!-- LEGAL-REVISION:END id=4872e9c135fae6d996d2 -->
...
#### Derogace předchozí právní úpravy

§ 99 je klasickým zrušovacím ustanovením, jímž zákon č. 458/2000 Sb. deroguje předchozí energetický zákon a navazující novelizační článek:

**Zákon č. 222/1994 Sb.** byl první samostatnou kodifikací podmínek podnikání v energetice po roce 1989. Reguloval výrobu, přenos, distribuci a obchod s elektřinou, přepravu, distribuci a obchod s plynem a teplárenství. Zřídil Státní energetickou inspekci a zavedl licenční systém v základní podobě. Zákon byl v době svého přijetí průlomový, avšak nestačil rychle se měnícím požadavkům liberalizované energetiky dle prvního balíčku směrnic EU (směrnice 96/92/ES o elektřině a 98/30/ES o plynu). Zákon č. 458/2000 Sb. byl přijat jako jeho komplexní náhrada, implementující první unijní balíček vnitřního trhu s energií.

**Článek V zákona č. 83/1998 Sb.** byl novelou zákona č. 222/1994 Sb. obsažená v předpisové části zákona, jenž primárně novelizoval stavební zákon. Tento článek, spolu se zákonem č. 222/1994 Sb. samotným, byl nahrazen komplexní úpravou EnZ.
...
<!-- LEGAL-REVISION:BEGIN id=9c1e460f49d1d4acfdba generator=2026-07-17.4 source_sha256=57876e790ac9dc77563d9dcc03e109fca09df7493f9c4204cd3ff9184f09d947 -->
#### Revizní doplnění k § 99 — Závěrečná ustanovení
...
> Zrušují se:
>
> - 1. [[Zákon č. 222/1994 Sb., o podmínkách podnikání a o výkonu státní správy v energetických odvětvích a o Státní energetické inspekci|Zákon č. 222/1994 Sb., o podmínkách podnikání a o výkonu státní správy v energetických odvětvích a o Státní energetické inspekci]].
>
> - 2. Článek V [[zákona č. 83/1998 Sb., kterým se mění a doplňuje zákon č. 50/1976 Sb., o územním plánování a stavebním řádu (stavební zákon), ve znění pozdějších předpisů, a o změně a doplnění některých dalších zákonů|zákona č. 83/1998 Sb., kterým se mění a doplňuje zákon č. 50/1976 Sb., o územním plánování a stavebním řádu (stavební zákon), ve znění pozdějších předpisů, a o změně a doplnění některých dalších zákonů]].
...
<!-- LEGAL-REVISION:END id=9c1e460f49d1d4acfdba -->
...
Část čtvrtá (§ 102) novelizuje zákon č. 455/1991 Sb., živnostenský zákon, konkrétně skupinu 207 přílohy č. 2 (vázané živnosti — chemická výroba). Do této skupiny byl doplněn nový obor vázané živnosti:

- **Obor:** Nákup, prodej a skladování zkapalněných uhlovodíkových plynů v tlakových nádobách, včetně jejich dopravy
...
#### Datum účinnosti a délka legisvakance

Zákon č. 458/2000 Sb. byl schválen a podepsán v roce 2000 (podpisy Klaus, Havel, Zeman jsou připojeny na konci textu zákona) a nabyl účinnosti **1. ledna 2001** — s legisvakancí přibližně několika měsíců od vyhlášení. Tato délka odpovídala potřebě připravit prováděcí předpisy (první vyhlášky ERÚ k měření, připojování, kvalitě dodávek) a organizačně konstituovat ERÚ jako zcela nový správní orgán.
...
> Tato kapitola uzavírá komentář k zákonu č. 458/2000 Sb., energetický zákon, ve znění konsolidovaném k 1. 1. 2026. Kapitola pokrývá §§ 96–99 (Hlava V — Společná, přechodná a závěrečná ustanovení) a stručně části druhou, čtvrtou a šestou (novelizační části a účinnost). Celkový přehled struktury komentáře viz ostatní kapitoly tohoto komentáře.
